...
class iApp{
  ...
  public function Info_Empleado($EmpresaNombre,$csc_Empresa,$csc_Empleado){
	...
	,CASE
		WHEN [EMPLAB_AUX].[EMPLEADO_CSC_EMPLEADO] IS NOT NULL THEN [EMPLAB_AUX].[EMPRESA_LABORAL_CSC]
		ELSE [EMP_LABORA].[EMPRESA_LABORAL_CSC]
	END AS [EMPRESA_LABORAL_CSC]

	,CASE
		WHEN [EMPLAB_TORR].[EMPRESA_LABORAL_RAZONSOCIALNOMBRE] IS NOT NULL THEN [EMPLAB_TORR].[EMPRESA_LABORAL_RAZONSOCIALNOMBRE]
		ELSE [EMP_LABORA].[EMPRESA_LABORAL_RAZONSOCIALNOMBRE]
	END AS [EMPRESA_LABORAL_RAZONSOCIALNOMBRE]

	,CASE
		WHEN [EMPLAB_TORR].[EMPRESA_LABORAL_ESTADO] IS NOT NULL THEN [EMPLAB_TORR].[EMPRESA_LABORAL_ESTADO]
		ELSE [EMP_LABORA].[EMPRESA_LABORAL_ESTADO]
	END AS [EMPRESA_LABORAL_ESTADO]

	,CASE
		WHEN [EMPLAB_TORR].[EMPRESA_LABORAL_MUNICIPIO] IS NOT NULL THEN [EMPLAB_TORR].[EMPRESA_LABORAL_MUNICIPIO]
		ELSE [EMP_LABORA].[EMPRESA_LABORAL_MUNICIPIO]
	END AS [EMPRESA_LABORAL_MUNICIPIO]

	,CASE
		WHEN [EMPLAB_TORR].[EMPRESA_LABORAL_COLONIA] IS NOT NULL THEN [EMPLAB_TORR].[EMPRESA_LABORAL_COLONIA]
		ELSE [EMP_LABORA].[EMPRESA_LABORAL_COLONIA]
	END AS [EMPRESA_LABORAL_COLONIA]

	,CASE
		WHEN [EMPLAB_TORR].[EMPRESA_LABORAL_CODIGOPOSTAL] IS NOT NULL THEN [EMPLAB_TORR].[EMPRESA_LABORAL_CODIGOPOSTAL]
		ELSE [EMP_LABORA].[EMPRESA_LABORAL_CODIGOPOSTAL]
	END AS [EMPRESA_LABORAL_CODIGOPOSTAL]

	,CASE
		WHEN [EMPLAB_TORR].[EMPRESA_LABORAL_LAT] IS NOT NULL THEN [EMPLAB_TORR].[EMPRESA_LABORAL_LAT]
		ELSE [EMP_LABORA].[EMPRESA_LABORAL_LAT]
	END AS [EMPRESA_LABORAL_LAT]

	,CASE
		WHEN [EMPLAB_TORR].[EMPRESA_LABORAL_LONG] IS NOT NULL THEN [EMPLAB_TORR].[EMPRESA_LABORAL_LONG]
		ELSE [EMP_LABORA].[EMPRESA_LABORAL_LONG]
	END AS [EMPRESA_LABORAL_LONG]

	,CASE
		WHEN [EMPLAB_TORR].[EMPRESA_LABORAL_DIRECCION] IS NOT NULL THEN [EMPLAB_TORR].[EMPRESA_LABORAL_DIRECCION]
		ELSE [EMP_LABORA].[EMPRESA_LABORAL_DIRECCION]
	END AS [EMPRESA_LABORAL_DIRECCION]

	,CASE
		WHEN [EMPLAB_TORR].[EMPRESA_LABORAL_TELEFONO] IS NOT NULL THEN [EMPLAB_TORR].[EMPRESA_LABORAL_TELEFONO]
		ELSE [EMP_LABORA].[EMPRESA_LABORAL_TELEFONO]
	END AS [EMPRESA_LABORAL_TELEFONO]
    
    FROM SAMT_EMPLEADOS AS EMPL

	LEFT JOIN [SAMT_EMPLEADO_EMPRESA_LABORAL] AS [EMPLAB_AUX] ON
	[EMPLAB_AUX].EMP_CSC_EMPRESA_HOST = [EMPL].[EMP_CSC_EMPRESA_HOST] AND
	[EMPLAB_AUX].[CLIENTE_CSC] = [EMPL].[CLIENTE_CSC] AND
	[EMPLAB_AUX].[EMPLEADO_CSC_EMPLEADO] = [EMPL].[EMPLEADO_CSC_EMPLEADO] 

	LEFT JOIN [SAMT_CAM_EMPRESA_LABORAL_TORRE] AS [EMPLAB_TORR] ON
	[EMPLAB_AUX].EMP_CSC_EMPRESA_HOST = [EMPLAB_TORR].[EMP_CSC_EMPRESA_HOST] AND
	[EMPLAB_AUX].[CLIENTE_CSC] = [EMPLAB_TORR].[CLIENTE_CSC] AND
	[EMPLAB_AUX].[EMPRESA_LABORAL_CSC] = [EMPLAB_TORR].[EMPRESA_LABORAL_CSC] 
...
public function GetFechaCatorcena($obj){
 ...
 public function GetEmplCargo($obj){
  ...
  LEFT JOIN SAMT_CAM_SERVICIO AS P_CAMPANIA
  ON P_CAMPANIA.CAM_CSC_SERVICIO = EMPL.CAM_CSC_SERVICIO AND P_CAMPANIA.EMP_CSC_EMPRESA_HOST = EMPL.EMP_CSC_EMPRESA_HOST
  FULL JOIN SAMT_CAT_ESTATUS_PROCESO_MPLEADOS AS PROCESOEMPLEADO
  ...
  AND PROCESOEMPLEADO.CAT_ESTATUS_PROCESO_EMP_CLAVE = 'ACT'
