SalesDashboard.dashboardModel = function() {
    ...
    self.inicativasDGMEIA = [18,19,20,21,36];
    ...
    */
    ...
    self._Obj_Activos_Grid_Busqueda = new DevExpress.data.ArrayStore({data: []});

    self._DatosComplementariosTicket = {};
    self.init = function() {
                    ...
                    options: {
                      ...
                      onClick() {
                        ...
                        if (self.Frm_Ticket_Servicio_Instance.getEditor("TIC_NEWID").option("value") == "") {
                            ...
                            //AL CERRAR EL TICKET PARA UNINET 
                            if (__ValidaEnvio.ESTATUS_TICKET_CLAVE == "RESUELTO" ) {
                                //|| __ValidaEnvio.ESTATUS_TICKET_CLAVE == "CANCELADO" || __ValidaEnvio.ESTATUS_TICKET_CLAVE == "CERRADO"
                            ...
                            if ( self.DataTicketOpen.TIC_CERRADO == true) {
                                ...
                                switch (getUrlParam('TPO_USUARIO')) {
                                    case 'GENERA':
                                        ...
                                        self.Frm_Ticket_Servicio_Instance.getEditor("REQ_CSCREQUISICION").option('readOnly', true);
                                    ...
                                    default:
                                        ...
                                        self.Frm_Ticket_Servicio_Instance.getEditor("PM_CSC_PROYECTO_SOLICITA").option('readOnly', true);
                                        self.Frm_Ticket_Servicio_Instance.getEditor("TIPIFICA_CSC_PARENT_PARENT").option('readOnly', true);
                                        self.Frm_Ticket_Servicio_Instance.getEditor("TIPIFICA_CSC_PARENT").option('readOnly', true);
                                        self.Frm_Ticket_Servicio_Instance.getEditor("TIPIFICA_CSC").option('readOnly', true);
                                        self.Frm_Ticket_Servicio_Instance.getEditor("CAM_CSC_SERVICIO_SOLICITA").option('readOnly', true);
                                        self.Frm_Ticket_Servicio_Instance.getEditor("TIC_CODIGO_VPN").option('readOnly', true);
                                        self.Frm_Ticket_Servicio_Instance.getEditor("TAG_COMPONENTE").option('readOnly', true);
                                        self.Frm_Ticket_Servicio_Instance.getEditor("TIC_SEGMENTACION_INM_DES").option('readOnly', true);
                                ...
                                if (__ValidaCambiosTicket == true) {
                                    ...
                                    /*if(self.pauseTicket == true){
                                        if (Form_Data_Ticket_servicio.TIC_ESTATUS_SLA_ENUM == 'open' || Form_Data_Ticket_servicio.TIC_ESTATUS_SLA_ENUM == '') {
                                            ...
                                            let tokenMesaProveedor = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJwcm92aWRlcl9kYXRhIjp7InByb3ZpZGVyX2lkIjoyNCwicHJvdmlkZXJfbmFtZSI6Ik1FU0EgREUgQVlVREEgQ09WRUNBIDIiLCJwcm92aWRlcl9pZF9lbXAiOjI1MywicHJvdmlkZXJfZW1waG9zdCI6MSwicHJvdmlkZXJfc2VydmljaW8iOjI0LCJjb250ZXh0Ijp7ImNsaWVudFR5cGUiOiJhcGkifX0sImlhdCI6MTcyMzY1MzUxMX0.dVLiQuwuRhE6TZwm9PpCrsk_Ph-YS_A_UslNDqnmL8I';
                                            __Reques_ajax('http://localhost:3007/pauseTicket/'+self.Frm_Ticket_Servicio_Instance.getEditor('CAM_CSC_SERVICIO_SOLICITA').option('value'),'POST',JSON.stringify({
                                        ...
                                        if (Form_Data_Ticket_servicio.TIC_ESTATUS_SLA_ENUM == 'pause') {
                                            //Obj_Data_Update_Ticket.TIC_ESTATUS_SLA_ENUM = 'pause';
                                            let tokenMesaProveedor = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJwcm92aWRlcl9kYXRhIjp7InByb3ZpZGVyX2lkIjoyNCwicHJvdmlkZXJfbmFtZSI6Ik1FU0EgREUgQVlVREEgQ09WRUNBIDIiLCJwcm92aWRlcl9pZF9lbXAiOjI1MywicHJvdmlkZXJfZW1waG9zdCI6MSwicHJvdmlkZXJfc2VydmljaW8iOjI0LCJjb250ZXh0Ijp7ImNsaWVudFR5cGUiOiJhcGkifX0sImlhdCI6MTcyMzY1MzUxMX0.dVLiQuwuRhE6TZwm9PpCrsk_Ph-YS_A_UslNDqnmL8I';
                                            __Reques_ajax('http://localhost:3007/resumeTicket/'+self.Frm_Ticket_Servicio_Instance.getEditor('CAM_CSC_SERVICIO_SOLICITA').option('value'),'POST',JSON.stringify({
                                                "newIdTicket":self.DataTicketOpen.TIC_NEWID,
                                                "idEmpresa": 1,
                                                "idEmpleadoProvider": 254
                                            }),tokenMesaProveedor).then((in_emp)=>{
                                    ...
                                    let tpoTicketSel = self.Frm_Ticket_Servicio_Instance.getEditor('TIPO_TICKET_CSC').option('selectedItem');
                                    ...
                                    var __Obj_Update = {
                                        ...
                                        "TIC_ID_EXTERNO_PROVEEDOR": self.DataTicketOpen.TIC_ID_EXTERNO_PROVEEDOR,
                                        "TIC_TIPO_CATEGORIA": tpoTicketSel.TIPO_TICKET_IDIOMA2,
                                        DATA_WHERE:{
                                            "CAM_CSC_SERVICIO_SOLICITA": self.DataTicketOpen.CAM_CSC_SERVICIO_SOLICITA,
                                    ...
                                    __Reques_ajax(getJSON(DeveloperType).ApiTickets_v2.url+'Update_Ticket_Servicio','POST',JSON.stringify(__Obj_Update),getJSON(DeveloperType).ApiTickets_v2.token).then((in_emp)=>{
                                        if (in_emp.success == true) {
                                            ...
                                            //if (__ValidaEnvio.ESTATUS_TICKET_CLAVE == "RESUELTO" || __ValidaEnvio.ESTATUS_TICKET_CLAVE == "ORIGEN" || __ValidaEnvio.ESTATUS_TICKET_CLAVE == "RECHAZO" || __ValidaEnvio.ESTATUS_TICKET_CLAVE == "SOLDOC") {
                                                ...
                                                let inmSelected = self.Frm_Ticket_Servicio_Instance.getEditor('REQ_CSCREQUISICION').option('selectedItem');
                                                let MesaSelected = self.Frm_Ticket_Servicio_Instance.getEditor('CAM_CSC_SERVICIO_SOLICITA').option('selectedItem');
                                                let MesaSelected1 = self.Frm_Ticket_Servicio_Instance.getEditor('PM_CSC_PROYECTO_SOLICITA').option('selectedItem');

                                                let puntoTactico = null;
                                                let tecnologia = null;
                                                let _cmbInmDGMEIASelected = self.Frm_Ticket_Servicio_Instance.getEditor('INM_CSCINMUEBLE').option('selectedItem');
                                    
                                                if (self.inicativasDGMEIA.includes(MesaSelected.CAM_CSC_SERVICIO)) {
                                                    puntoTactico = _cmbInmDGMEIASelected.REQUISICION_PROVEEDORES_NOMBRE;
                                                    let extrjsn = JSON.parse(self.Frm_Ticket_Servicio_Instance.getEditor('TIC_JSON_EXTRA_PARAMS').option('value')); 
                                                    tecnologia = extrjsn.tpoBien
                                                } else{
                                                    puntoTactico = inmSelected.REQUISICION_PROVEEDORES_CODIGO_VPN
                                                    tecnologia = MesaSelected1.PM_NOMBRE;
                                                }

                                                let infoMensaje = `
                                                <b>Estatus:</b> ${__ValidaEnvio.ESTATUS_TICKET_IDIOMA1} 
                                                <br><b>Aduana:</b> ${inmSelected.REQUISICION_PROVEEDORES_NOMBRE} 
                                                <br><b>Punto táctico:</b> ${puntoTactico} 
                                                <br><b>Numero de serie:</b> ${self.DataTicketOpen.TAG_COMPONENTE} 
                                                <br><b>Nombre:</b> ${self.DataTicketOpen.TIC_SOLICITA} 
                                                <br><b>Teléfono:</b> ${self.DataTicketOpen.TIC_TELEFONO_SOLICITANTE} 
                                                <br><b>Tecnología:</b> ${tecnologia} 
                                                <br><b>Proveedor:</b> ${MesaSelected.CAM_SERVICIO_NOMBRE} 
                                                <br><br><b>Descripción:</b> ${self.DataTicketOpen.TIC_DESCRIPCION}`
                    ...
                    onClick() {
                        ...
                        __Reques_ajax(getJSON(DeveloperType).ApiTickets_v2.url+'Insert_Respuesta_Mensaje','POST',JSON.stringify(objInsert),getJSON(DeveloperType).ApiTickets_v2.token).then((in_emp)=>{
                            if (in_emp.success == true) {
                                ...
                                if (self.Frm_Ticket_Servicio_Instance.getEditor("CAM_CSC_SERVICIO_SOLICITA").option("value") == 5) {
                                    _DatosRespuestaAlta.TIC_CSCTICKET = self.Frm_Ticket_Servicio_Instance.getEditor("TIC_ID_EXTERNO_PROVEEDOR").option("value")
                                    let dataMsgMaaToProvider = {
                                        EMP_CLV_EMPRESA: "CREATIF",
                                        EMP_CSC_EMPRESA_HOST: "1",
                                        TimeZoneCliente: "America/Mexico_City",
                                        TimeZoneServer: "Etc/GMT",
                                        Type: "Pro",
                                        DATA_INSERT: _DatosRespuestaAlta
                                    };
        
                                    __Reques_ajax('https://apioracle.dnasystem.io/api/Api_Tickets_v2/Insert_Respuesta_Mensaje','POST',JSON.stringify(dataMsgMaaToProvider),getJSON(DeveloperType).ApiTickets_v2.token).then((creatif_response)=>{
                                        console.log(creatif_response);
                                        
                                        if (creatif_response.success == true) {
                                            DevExpress.ui.notify({message: `Mensaje creado a proveedor`,minWidth: 150,type: 'success',displayTime: 5000},{position: "bottom right",direction: "up-push"});
                                        }
        
                                    })
                                }
                                if (self.Frm_Ticket_Servicio_Instance.getEditor("CAM_CSC_SERVICIO_SOLICITA").option("value") == 38) {
                                    _DatosRespuestaAlta.TIC_CSCTICKET = self.Frm_Ticket_Servicio_Instance.getEditor("TIC_ID_EXTERNO_PROVEEDOR").option("value")
                                    let dataMsgMaaToProvider = {
                                        EMP_CLV_EMPRESA: "SRMSOTIC",
                                        EMP_CSC_EMPRESA_HOST: "1",
                                        TimeZoneCliente: "America/Mexico_City",
                                        TimeZoneServer: "Etc/GMT",
                                        Type: "Pro",
                ...
                options: {
                    ...
                    onClick() {
                        ...
                        if ($("#frmCalificaTicket").dxForm("instance").validate().isValid === true) {
                            ...
                            let itemsEstatusComponent = self._CMB_SAMT_ESTATUS_TICKET_OBJDATA._array;
                            
                            let __Estatus_Ticket_Calif = null
                            
                            var obj_BitacoraSend = {}
                            obj_BitacoraSend.TIC_CSCTICKET = self.DataTicketOpen.TIC_CSCTICKET;
                            obj_BitacoraSend.ESTATUS_TICKET_CSC = __ValidaEnvio.ESTATUS_TICKET_CSC;

                            if (frm.TIPO_CALIFICACION_CSC == 3) {
                                self.InsertaBitacoraManual(obj_BitacoraSend,`Ticket no atendido: ${frm.TIC_CALIFICACION_COMENTARIO}`, false, 2,1);
                                __Estatus_Ticket_Calif = jslinq(itemsEstatusComponent).where(function(el) {
                                    return el.ESTATUS_TICKET_ACTIVO == 1 && el.CAM_CSC_SERVICIO == self.DataTicketOpen.CAM_CSC_SERVICIO_SOLICITA && el.ESTATUS_TICKET_REASIGNAR == 1;
                                }).toList();
                                Obj_Data_Update_Ticket.TIC_FECHA_CIERRE = null;
                            } else{
                                __Estatus_Ticket_Calif = jslinq(itemsEstatusComponent).where(function(el) {
                                    return el.ESTATUS_TICKET_ACTIVO == 1 && el.CAM_CSC_SERVICIO == self.DataTicketOpen.CAM_CSC_SERVICIO_SOLICITA && el.ESTATUS_TICKET_CLAVE == 'CERRADO';
                                }).toList();
                                Obj_Data_Update_Ticket.TIC_CERRADO = true;
                                Obj_Data_Update_Ticket.TIC_CERRADO_POR_SISTEMA = 0;
                                self.InsertaBitacoraManual(obj_BitacoraSend,`Ticket atendido y cerrado: ${frm.TIC_CALIFICACION_COMENTARIO}`, false, 2,1);
                            }
                            ...
                            Obj_Data_Update_Ticket.ESTATUS_TICKET_CSC = __Estatus_Ticket_Calif[0].ESTATUS_TICKET_CSC;
                            ...
                            __Reques_ajax(getJSON(DeveloperType).ApiTickets_v2.url+'Update_Ticket_Servicio','POST',JSON.stringify(__Obj_Update),getJSON(DeveloperType).ApiTickets_v2.token).then((in_emp)=>{
                                if (in_emp.success == true) {
                                    ...
                                    var obj_BitacoraSend = {}
                                        ...
                                        let ResProvider = in_emp.ResProvider;

                                        if (ResProvider != null) {
                                            if (ResProvider.isSuccessProvider == false) {
                                                self.notificaPantalla("Alerta!", moment().tz(self.TimeZoneEmpleado).format(' DD/MM/YYYY HH:mm'), `Error al calificar el ticket del proveedor: ${JSON.stringify(in_emp.ResProvider.errorDetail.message.message)}`, 400, 140)
                                                self.InsertaBitacoraManual(obj_BitacoraSend,JSON.stringify(ResProvider.errorDetail), false, 2,1);
                                            } else{
                                                self.InsertaBitacoraManual(obj_BitacoraSend,JSON.stringify(ResProvider.Detail), false, 1,2);    
                                            }
                                        } else {
                                            self.InsertaBitacoraManual(obj_BitacoraSend,JSON.stringify(ResProvider.Detail), false, 1,2);
                                        } 
            ...
            toolbarItems: [{
                ...
                options: {
                    ...
                    onClick() {
                        ...
                        self.InsertaBitacoraManual(DetalleTicket,frm.INFO_BITACORA,false,1,1,'Envioaproveedor');
                    },
                },
            },{
                widget: 'dxButton',
        ...
        self.muestraPopComplementosTicket=function(tipoFormulario){
            $('#Pop_Agregar_DatosComplementarios').dxPopup({
                width: 400,
                height: 300,
                visible: false,
                showTitle: false,
                ...
                hideOnOutsideClick: false,
                contentTemplate: function(e) {  
                    var formContainer = $("<div id='Frm_DatosComplementarios'>");  
                    formContainer.dxForm({  
                        readOnly: false,
                        showColonAfterLabel: true,
                        showValidationSummary: false,
                        validationGroup: 'Validacion_Frm_DatosComplementarios',
                        labelMode: 'static',
                        labelLocation: 'top',
                        colCount:1,
                        screenByWidth(width) {
                        ...
                        items:[{
                                colSpan:2,
                                dataField: "FechaAplicaString",
                                editorType: "dxDateBox",
                                label: { 
                                        text: `FECHA DE ${tipoFormulario}`
                                },
                                editorOptions: {
                                    type: 'date',
                                    width:'100%',
                ...
                toolbarItems: [{
                    ...
                    options: {
                        ...
                        text: 'Agregar',
                        onClick() {
                            if($("#Frm_DatosComplementarios").dxForm("instance").validate().isValid === false){
                                self.notificaPantalla("Alerta", moment().tz(self.TimeZoneEmpleado).format(' DD/MM/YYYY HH:mm'), `Todos los campos marcados con * son obligatorios.`, 400, 130);
                                return;
                            }
                            var frm = $("#Frm_DatosComplementarios").dxForm("instance").option('formData');
                            self._DatosComplementariosTicket = frm;
                            self.Frm_Ticket_Servicio_Instance.getEditor('TIC_JSON_EXTRA_PARAMS').option('value',JSON.stringify(self._DatosComplementariosTicket));
                            $('#Pop_Agregar_DatosComplementarios').dxPopup("hide");
                        },
                    },
                },{
                    widget: 'dxButton',
            ...
            $("#Pop_Agregar_DatosComplementarios").dxPopup("show");

            if (tipoFormulario == "ALTA") {
            }
            
            if (tipoFormulario == "BAJA") {
                $("#Frm_DatosComplementarios").dxForm("instance").itemOption('FechaAplicaString', 'visible', true);    
                $("#Frm_DatosComplementarios").dxForm("instance").itemOption('MarcaString', 'visible', false);    
                $("#Frm_DatosComplementarios").dxForm("instance").itemOption('ModeloString', 'visible', false);        
                $("#Frm_DatosComplementarios").dxForm("instance").itemOption('NumeroSerieString', 'visible', false);    
            } else if (tipoFormulario == "CAMBIO") {
                $("#Frm_DatosComplementarios").dxForm("instance").itemOption('FechaAplicaString', 'visible', true);    
                $("#Frm_DatosComplementarios").dxForm("instance").itemOption('MarcaString', 'visible', true);    
                $("#Frm_DatosComplementarios").dxForm("instance").itemOption('ModeloString', 'visible', true);       
                $("#Frm_DatosComplementarios").dxForm("instance").itemOption('NumeroSerieString', 'visible', true);  
            }
            //$("#Frm_DatosComplementarios").dxForm("instance").itemOption("ModeloString", 'isRequired', true);
        }

        self.popDatosSiadeconSrv=function(tipoFormulario){
            $('#Pop_Agregar_DatosComplementarios_Siadeconsrv').dxPopup({
                width: 400,
                height: 450,
                visible: false,
                showTitle: false,
                ...
                hideOnOutsideClick: false,
                contentTemplate: function(e) {  
                    var formContainer = $("<div id='Frm_DatosComplementariosSiadeconSrv'>");  
                    formContainer.dxForm({  
                        readOnly: false,
                        showColonAfterLabel: true,
                        showValidationSummary: false,
                        validationGroup: 'Validacion_Frm_DatosComplementariosSiadeconSrv',
                        labelMode: 'static',
                        labelLocation: 'top',
                        colCount:1,
                        screenByWidth(width) {
                        ...
                        items:[
                            {
                                colSpan:2,
                                dataField: "DATOS_SIADECONSRV_NOMBRES", 
                                editorType: "dxTextBox",
                            ...
                            {
                                colSpan:2,
                                dataField: "DATOS_SIADECONSRV_APELLIDO_PATERNO", 
                                editorType: "dxTextBox",
                            ...
                            {
                                colSpan:2,
                                dataField: "DATOS_SIADECONSRV_APELLIDO_MATERNO",
                                editorType: "dxTextBox",
                            ...
                            {
                                colSpan:2,
                                dataField: "DATOS_SIADECONSRV_RFC",
                                editorType: "dxTextBox",
                            ...
                            {
                                colSpan:2,
                                dataField: "DATOS_SIADECONSRV_EMAIL",
                                editorType: "dxTextBox",
                                
                                label: {
                                    text: 'Mail (institucional)'
                                },
                                editorOptions: {
                                    readOnly: false,
                                },
                            ...
                            {
                                colSpan:2,
                                dataField: "DATOS_SIADECONSRV_ADUANA_CSC",
                                editorType: "dxSelectBox",
                                ...
                                editorOptions: {
                                    searchEnabled:true,
                                    displayExpr: "ADUANAS_DESCRIPCION",
                                    valueExpr: "SAMT_CAT_SIADECONSRV_ADUANAS_CSC",
                                    dataSource: new DevExpress.data.DataSource({
                                        store: new DevExpress.data.CustomStore({
                                            key: _keyTpoAreaCsc,
                                            loadMode: "raw", paginate: false,   
                                            load: async function () {
                                                var _ary = {Tbl:"SAMT_CAT_SIADECONSRV_ADUANAS"};
                                                return __Get_catalogos(getJSON(DeveloperType).ApiGeneral.url+'Get_Cat_Full','GET',_ary,getJSON(DeveloperType).ApiGeneral.token).then((all_data)=>{
                                                    if (all_data.success == true){
                                                        return jslinq( all_data.JsonData ).orderBy(function(el){return el.ADUANAS_DESCRIPCION;}).toList();
                                    ...
                                    onOpened: function(e) {
                                        e.component.getDataSource().load().done(function(data) {
                                            self.CAT_SIADECONSRV_ADUANAS = data;
                                            var __ActiveCat = jslinq(data).where(function(el) {
                                                return el.ADUANAS_ACTIVO == 1;
                                            }).toList();
                                            e.component.option('dataSource', __ActiveCat);
                                        });
                                    },
                                    onClosed: function(e) {
                                        if (e.component.getDataSource().items() !== self.CAT_SIADECONSRV_ADUANAS) {
                                            e.component.option('dataSource', self.CAT_SIADECONSRV_ADUANAS);
                                        }
                                    },
                                    onValueChanged: function (e) {
                            ...
                            {
                                colSpan:2,
                                dataField: "DATOS_SIADECONSRV_PUNTO_TACTICO",
                                editorType: "dxTextBox",
                            ...
                            {
                                colSpan:2,
                                dataField: "DATOS_SIADECONSRV_AREA",
                                editorType: "dxTextBox",
                            ...
                            {
                                colSpan:2,
                                dataField: "DATOS_SIADECONSRV_JERARQUIA_CSC",
                                editorType: "dxSelectBox",
                                ...
                                editorOptions: {
                                    searchEnabled:true,
                                    displayExpr: "JERARQUIAS_DESCRIPCION",
                                    ...
                                    dataSource: new DevExpress.data.DataSource({
                                        store: new DevExpress.data.CustomStore({
                                            ...
                                            loadMode: "raw", paginate: false,   
                                            load: async function () {
                                                var _ary = {Tbl:"SAMT_CAT_SIADECONSRV_JERARQUIAS"};
                                                return __Get_catalogos(getJSON(DeveloperType).ApiGeneral.url+'Get_Cat_Full','GET',_ary,getJSON(DeveloperType).ApiGeneral.token).then((all_data)=>{
                                                    if (all_data.success == true){
                                                        return jslinq( all_data.JsonData ).orderBy(function(el){return el.JERARQUIAS_DESCRIPCION;}).toList();
                                                        //return jslinq( all_data.JsonData ).orderBy(function(el){return el.TIPO_AREA_IDIOMA1;}).toList();;
                                                    }
                                                    else {
                                                        console.log(all_data.message);
                                    ...
                                    onOpened: function(e) {
                                        e.component.getDataSource().load().done(function(data) {
                                            self.CAT_JERARQUIAS_DESCRIPCION = data;
                                            var __ActiveCat = jslinq(data).where(function(el) {
                                                return el.JERARQUIAS_ACTIVO == 1;
                                            }).toList();
                                            e.component.option('dataSource', __ActiveCat);
                                        });
                                    },
                                    onClosed: function(e) {
                                        if (e.component.getDataSource().items() !== self.CAT_JERARQUIAS_DESCRIPCION) {
                                            e.component.option('dataSource', self.CAT_JERARQUIAS_DESCRIPCION);
                                        }
                                    },
                                    onValueChanged: function (e) {
                            ...
                            {
                                colSpan:2,
                                dataField: "DATOS_SIADECONSRV_VIN",
                                editorType: "dxTextBox",
                            ...
                            {
                                colSpan:2,
                                dataField: "DATOS_SIADECONSRV_PLACA",
                                editorType: "dxTextBox",
                            ...
                            {
                                colSpan:2,
                                dataField: "DATOS_SIADECONSRV_PAIS_CSC",
                                editorType: "dxSelectBox",
                                ...
                                editorOptions: {
                                    searchEnabled:true,
                                    displayExpr: "PAIS_NOMBRE",
                                    valueExpr: "SAMT_CAT_SIADECONSRV_PAIS_CSC",
                                    dataSource: new DevExpress.data.DataSource({
                                        store: new DevExpress.data.CustomStore({
                                            key: _keyTpoAreaCsc,
                                            loadMode: "raw", paginate: false,   
                                            load: async function () {
                                                var _ary = {Tbl:"SAMT_CAT_SIADECONSRV_PAIS"};
                                                return __Get_catalogos(getJSON(DeveloperType).ApiGeneral.url+'Get_Cat_Full','GET',_ary,getJSON(DeveloperType).ApiGeneral.token).then((all_data)=>{
                                                    if (all_data.success == true){
                                                        return jslinq( all_data.JsonData ).orderBy(function(el){return el.PAIS_NOMBRE;}).toList();
                                                        //return jslinq( all_data.JsonData ).orderBy(function(el){return el.TIPO_AREA_IDIOMA1;}).toList();;
                                                    }
                                                    else {
                                                        console.log(all_data.message);
                                    ...
                                    onOpened: function(e) {
                                        e.component.getDataSource().load().done(function(data) {
                                            self.SAMT_CAT_SIADECONSRV_PAIS_CSC = data;
                                            var __ActiveCat = jslinq(data).where(function(el) {
                                                return el.PAIS_ACTIVO == 1;
                                            }).toList();
                                            e.component.option('dataSource', __ActiveCat);
                                        });
                                    },
                                    onClosed: function(e) {
                                        if (e.component.getDataSource().items() !== self.SAMT_CAT_SIADECONSRV_PAIS_CSC) {
                                            e.component.option('dataSource', self.SAMT_CAT_SIADECONSRV_PAIS_CSC);
                                        }
                                    },
                                    onValueChanged: function (e) {
                            ...
                            {
                                colSpan:2,
                                dataField: "DATOS_SIADECONSRV_ENTIDAD_FEDERATIVA_CSC",
                                editorType: "dxSelectBox",
                                ...
                                editorOptions: {
                                    searchEnabled:true,
                                    displayExpr: "ENTIDAD_FEDERATIVA_NOMBRE",
                                    valueExpr: "SAMT_CAT_SIADECONSRV_ENTIDAD_FEDERATIVA_CSC",
                                    dataSource: new DevExpress.data.DataSource({
                                        store: new DevExpress.data.CustomStore({
                                            key: _keyTpoAreaCsc,
                                            loadMode: "raw", paginate: false,   
                                            load: async function () {
                                                var _ary = {Tbl:"SAMT_CAT_SIADECONSRV_ENTIDAD_FEDERATIVA"};
                                                return __Get_catalogos(getJSON(DeveloperType).ApiGeneral.url+'Get_Cat_Full','GET',_ary,getJSON(DeveloperType).ApiGeneral.token).then((all_data)=>{
                                                    if (all_data.success == true){
                                                        return jslinq( all_data.JsonData ).orderBy(function(el){return el.ENTIDAD_FEDERATIVA_NOMBRE;}).toList();
                                                        //return jslinq( all_data.JsonData ).orderBy(function(el){return el.TIPO_AREA_IDIOMA1;}).toList();;
                                                    }
                                                    else {
                                                        console.log(all_data.message);
                                    ...
                                    onOpened: function(e) {
                                        e.component.getDataSource().load().done(function(data) {
                                            self.SAMT_CAT_SIADECONSRV_ENTIDAD_FEDERATIVA_CSC = data;                                           
                                            let paisSelected =  $("#Frm_DatosComplementariosSiadeconSrv").dxForm("instance").getEditor('DATOS_SIADECONSRV_PAIS_CSC').option('selectedItem');
                                            var __ActiveCat = jslinq(data).where(function(el) {
                                                return el.ENTIDAD_FEDERATIVA_ACTIVO == 1 && el.SAMT_CAT_SIADECONSRV_PAIS == paisSelected.SAMT_CAT_SIADECONSRV_PAIS_CSC;
                                            }).toList();
                                            e.component.option('dataSource', __ActiveCat);
                                        });
                                    },
                                    onClosed: function(e) {
                                        if (e.component.getDataSource().items() !== self.SAMT_CAT_SIADECONSRV_ENTIDAD_FEDERATIVA_CSC) {
                                            e.component.option('dataSource', self.SAMT_CAT_SIADECONSRV_ENTIDAD_FEDERATIVA_CSC);
                                        }
                                    },
                                    onValueChanged: function (e) {
                            ...
                            {
                                colSpan:2,
                                dataField: "DATOS_SIADECONSRV_NOMBRE_LISTA_NEGRA_CSC",
                                editorType: "dxSelectBox",
                                
                                label: {
                                    text: 'Nombre lista negra'
                                },
                                editorOptions: {
                                    searchEnabled:true,
                                    displayExpr: "LISTA_NEGRA_DESCRIPCION",
                                    valueExpr: "SAMT_CAT_SIADECONSRV_LISTA_NEGRA_CSC",
                                    dataSource: new DevExpress.data.DataSource({
                                        store: new DevExpress.data.CustomStore({
                                            key: _keyTpoAreaCsc,
                                            loadMode: "raw", paginate: false,   
                                            load: async function () {
                                                var _ary = {Tbl:"SAMT_CAT_SIADECONSRV_LISTA_NEGRA"};
                                                return __Get_catalogos(getJSON(DeveloperType).ApiGeneral.url+'Get_Cat_Full','GET',_ary,getJSON(DeveloperType).ApiGeneral.token).then((all_data)=>{
                                                    if (all_data.success == true){
                                                        return jslinq( all_data.JsonData ).orderBy(function(el){return el.ENTIDAD_FEDERATIVA_NOMBRE;}).toList();
                                                        //return jslinq( all_data.JsonData ).orderBy(function(el){return el.TIPO_AREA_IDIOMA1;}).toList();;
                                    ...
                                    onOpened: function(e) {
                                        e.component.getDataSource().load().done(function(data) {
                                            self.LISTA_NEGRA_DESCRIPCION = data;                                           
                                            var __ActiveCat = jslinq(data).where(function(el) {
                                                return el.LISTA_NEGRA_ACTIVO == 1;
                                            }).toList();
                                            e.component.option('dataSource', __ActiveCat);
                                        });
                                    },
                                    onClosed: function(e) {
                                        if (e.component.getDataSource().items() !== self.LISTA_NEGRA_DESCRIPCION) {
                                            e.component.option('dataSource', self.LISTA_NEGRA_DESCRIPCION);
                                        }
                                    },
                                    onValueChanged: function (e) {
                ...
                toolbarItems: [{
                    ...
                    options: {
                        ...
                        text: 'Agregar',
                        onClick() {
                            if($("#Frm_DatosComplementariosSiadeconSrv").dxForm("instance").validate().isValid === false){
                                self.notificaPantalla("Alerta", moment().tz(self.TimeZoneEmpleado).format(' DD/MM/YYYY HH:mm'), `Todos los campos marcados con * son obligatorios.`, 400, 130);
                                return;
                            }
                            var frm = $("#Frm_DatosComplementariosSiadeconSrv").dxForm("instance").option('formData');
                            self._DatosComplementariosTicket = frm; 
                            var Form_Data_Ticket_servicio = self.Frm_Ticket_Servicio_Instance.option('formData');
                            var Obj_Data_Insert_Ticket_SiadeconSrv = frm;
                            Obj_Data_Insert_Ticket_SiadeconSrv.AUDITORIA_USU_ALTA = obj_DatosEmpleado.EMPLEADO_CSC_EMPLEADO;
                            Obj_Data_Insert_Ticket_SiadeconSrv.AUDITORIA_USU_ULT_MOD = obj_DatosEmpleado.EMPLEADO_CSC_EMPLEADO;
                            Obj_Data_Insert_Ticket_SiadeconSrv.AUDITORIA_FEC_ALTA = moment().tz(self.TimeZoneServidor).format('YYYY-MM-DD HH:mm:ss');
                            Obj_Data_Insert_Ticket_SiadeconSrv.AUDITORIA_FEC_ULT_MOD = moment().tz(self.TimeZoneServidor).format('YYYY-MM-DD HH:mm:ss');
                            Obj_Data_Insert_Ticket_SiadeconSrv.EMP_CSC_EMPRESA_HOST = localStorage.getItem('EMP_CSC_EMPRESA_HOST');
                            Obj_Data_Insert_Ticket_SiadeconSrv.TIC_NEWID = Form_Data_Ticket_servicio.TIC_NEWID;

                            var objInsert = {
                                ...ReturnDefaultData_Init(),
                                DATA_INSERT: Obj_Data_Insert_Ticket_SiadeconSrv
                            };

                            console.log(objInsert);

                            __Reques_ajax(getJSON(DeveloperType).ApiTickets_v2.url+'Insert_DataSiadecon','POST',JSON.stringify(objInsert),getJSON(DeveloperType).ApiTickets_v2.token).then((in_emp)=>{
                                if (in_emp.success == true){
                                    $('#Pop_Agregar_DatosComplementarios_Siadeconsrv').dxPopup("hide");
                                }
                                else {
                                    loadPanel.hide();
                                }
            ...
            $("#Pop_Agregar_DatosComplementarios_Siadeconsrv").dxPopup("show");

            if (tipoFormulario == "ALTA DE USUARIO") {
                $("#Frm_DatosComplementariosSiadeconSrv").dxForm("instance").itemOption('DATOS_SIADECONSRV_NOMBRES', 'visible', true);
                $("#Frm_DatosComplementariosSiadeconSrv").dxForm("instance").itemOption('DATOS_SIADECONSRV_APELLIDO_PATERNO', 'visible', true);
                $("#Frm_DatosComplementariosSiadeconSrv").dxForm("instance").itemOption('DATOS_SIADECONSRV_APELLIDO_MATERNO', 'visible', true);
                $("#Frm_DatosComplementariosSiadeconSrv").dxForm("instance").itemOption('DATOS_SIADECONSRV_RFC', 'visible', true);
                $("#Frm_DatosComplementariosSiadeconSrv").dxForm("instance").itemOption('DATOS_SIADECONSRV_EMAIL', 'visible', true);
                $("#Frm_DatosComplementariosSiadeconSrv").dxForm("instance").itemOption('DATOS_SIADECONSRV_ADUANA_CSC', 'visible', true);
                $("#Frm_DatosComplementariosSiadeconSrv").dxForm("instance").itemOption('DATOS_SIADECONSRV_PUNTO_TACTICO', 'visible', true);
                $("#Frm_DatosComplementariosSiadeconSrv").dxForm("instance").itemOption('DATOS_SIADECONSRV_ADUANA_CSC', 'visible', true);
                $("#Frm_DatosComplementariosSiadeconSrv").dxForm("instance").itemOption('DATOS_SIADECONSRV_AREA', 'visible', true);
                $("#Frm_DatosComplementariosSiadeconSrv").dxForm("instance").itemOption('DATOS_SIADECONSRV_JERARQUIA_CSC', 'visible', true);
                $("#Frm_DatosComplementariosSiadeconSrv").dxForm("instance").itemOption('DATOS_SIADECONSRV_VIN', 'visible', false);
                $("#Frm_DatosComplementariosSiadeconSrv").dxForm("instance").itemOption('DATOS_SIADECONSRV_PLACA', 'visible', false);
                $("#Frm_DatosComplementariosSiadeconSrv").dxForm("instance").itemOption('DATOS_SIADECONSRV_ENTIDAD_FEDERATIVA_CSC', 'visible', false);
                $("#Frm_DatosComplementariosSiadeconSrv").dxForm("instance").itemOption('DATOS_SIADECONSRV_PAIS_CSC', 'visible', false);
                $("#Frm_DatosComplementariosSiadeconSrv").dxForm("instance").itemOption('DATOS_SIADECONSRV_NOMBRE_LISTA_NEGRA_CSC', 'visible', false);
            }
            
            if (tipoFormulario == "BAJA DE USUARIO") {
                $("#Frm_DatosComplementariosSiadeconSrv").dxForm("instance").itemOption('DATOS_SIADECONSRV_NOMBRES', 'visible', false);
                $("#Frm_DatosComplementariosSiadeconSrv").dxForm("instance").itemOption('DATOS_SIADECONSRV_APELLIDO_PATERNO', 'visible', false);
                $("#Frm_DatosComplementariosSiadeconSrv").dxForm("instance").itemOption('DATOS_SIADECONSRV_APELLIDO_MATERNO', 'visible', false);
                $("#Frm_DatosComplementariosSiadeconSrv").dxForm("instance").itemOption('DATOS_SIADECONSRV_RFC', 'visible', false);
                $("#Frm_DatosComplementariosSiadeconSrv").dxForm("instance").itemOption('DATOS_SIADECONSRV_EMAIL', 'visible', true);
                $("#Frm_DatosComplementariosSiadeconSrv").dxForm("instance").itemOption('DATOS_SIADECONSRV_ADUANA_CSC', 'visible', false);
                $("#Frm_DatosComplementariosSiadeconSrv").dxForm("instance").itemOption('DATOS_SIADECONSRV_PUNTO_TACTICO', 'visible', false);
                $("#Frm_DatosComplementariosSiadeconSrv").dxForm("instance").itemOption('DATOS_SIADECONSRV_ADUANA_CSC', 'visible', false);
                $("#Frm_DatosComplementariosSiadeconSrv").dxForm("instance").itemOption('DATOS_SIADECONSRV_AREA', 'visible', false);
                $("#Frm_DatosComplementariosSiadeconSrv").dxForm("instance").itemOption('DATOS_SIADECONSRV_JERARQUIA_CSC', 'visible', false);
                $("#Frm_DatosComplementariosSiadeconSrv").dxForm("instance").itemOption('DATOS_SIADECONSRV_VIN', 'visible', false);
                $("#Frm_DatosComplementariosSiadeconSrv").dxForm("instance").itemOption('DATOS_SIADECONSRV_PLACA', 'visible', false);
                $("#Frm_DatosComplementariosSiadeconSrv").dxForm("instance").itemOption('DATOS_SIADECONSRV_ENTIDAD_FEDERATIVA_CSC', 'visible', false);
                $("#Frm_DatosComplementariosSiadeconSrv").dxForm("instance").itemOption('DATOS_SIADECONSRV_PAIS_CSC', 'visible', false);
                $("#Frm_DatosComplementariosSiadeconSrv").dxForm("instance").itemOption('DATOS_SIADECONSRV_NOMBRE_LISTA_NEGRA_CSC', 'visible', false);    
            } else if (tipoFormulario == "MONITOREO Y SEGUIMIENTO DE VEHÍCULOS") { 
                $("#Frm_DatosComplementariosSiadeconSrv").dxForm("instance").itemOption('DATOS_SIADECONSRV_NOMBRES', 'visible', false);
                $("#Frm_DatosComplementariosSiadeconSrv").dxForm("instance").itemOption('DATOS_SIADECONSRV_APELLIDO_PATERNO', 'visible', false);
                $("#Frm_DatosComplementariosSiadeconSrv").dxForm("instance").itemOption('DATOS_SIADECONSRV_APELLIDO_MATERNO', 'visible', false);
                $("#Frm_DatosComplementariosSiadeconSrv").dxForm("instance").itemOption('DATOS_SIADECONSRV_RFC', 'visible', false);
                $("#Frm_DatosComplementariosSiadeconSrv").dxForm("instance").itemOption('DATOS_SIADECONSRV_EMAIL', 'visible', false);
                $("#Frm_DatosComplementariosSiadeconSrv").dxForm("instance").itemOption('DATOS_SIADECONSRV_ADUANA_CSC', 'visible', false);
                $("#Frm_DatosComplementariosSiadeconSrv").dxForm("instance").itemOption('DATOS_SIADECONSRV_PUNTO_TACTICO', 'visible', false);
                $("#Frm_DatosComplementariosSiadeconSrv").dxForm("instance").itemOption('DATOS_SIADECONSRV_ADUANA_CSC', 'visible', false);
                $("#Frm_DatosComplementariosSiadeconSrv").dxForm("instance").itemOption('DATOS_SIADECONSRV_AREA', 'visible', false);
                $("#Frm_DatosComplementariosSiadeconSrv").dxForm("instance").itemOption('DATOS_SIADECONSRV_JERARQUIA_CSC', 'visible', false);
                $("#Frm_DatosComplementariosSiadeconSrv").dxForm("instance").itemOption('DATOS_SIADECONSRV_VIN', 'visible', true);
                $("#Frm_DatosComplementariosSiadeconSrv").dxForm("instance").itemOption('DATOS_SIADECONSRV_PLACA', 'visible', true);
                $("#Frm_DatosComplementariosSiadeconSrv").dxForm("instance").itemOption('DATOS_SIADECONSRV_ENTIDAD_FEDERATIVA_CSC', 'visible', true);
                $("#Frm_DatosComplementariosSiadeconSrv").dxForm("instance").itemOption('DATOS_SIADECONSRV_PAIS_CSC', 'visible', true);
                $("#Frm_DatosComplementariosSiadeconSrv").dxForm("instance").itemOption('DATOS_SIADECONSRV_NOMBRE_LISTA_NEGRA_CSC', 'visible', false);  
            } else if (tipoFormulario == `ACTUALIZACIÓN DE LISTA: "MEDIDA DE CONTROL CPED"`) { 
                $("#Frm_DatosComplementariosSiadeconSrv").dxForm("instance").itemOption('DATOS_SIADECONSRV_NOMBRES', 'visible', false);
                $("#Frm_DatosComplementariosSiadeconSrv").dxForm("instance").itemOption('DATOS_SIADECONSRV_APELLIDO_PATERNO', 'visible', false);
                $("#Frm_DatosComplementariosSiadeconSrv").dxForm("instance").itemOption('DATOS_SIADECONSRV_APELLIDO_MATERNO', 'visible', false);
                $("#Frm_DatosComplementariosSiadeconSrv").dxForm("instance").itemOption('DATOS_SIADECONSRV_RFC', 'visible', false);
                ...
                $("#Frm_DatosComplementariosSiadeconSrv").dxForm("instance").itemOption('DATOS_SIADECONSRV_ENTIDAD_FEDERATIVA_CSC', 'visible', true);
                $("#Frm_DatosComplementariosSiadeconSrv").dxForm("instance").itemOption('DATOS_SIADECONSRV_PAIS_CSC', 'visible', true);
                $("#Frm_DatosComplementariosSiadeconSrv").dxForm("instance").itemOption('DATOS_SIADECONSRV_NOMBRE_LISTA_NEGRA_CSC', 'visible', true);   
            }
        }
        ...
        self.TabPanel_Ticket_Detalle = $("#Tab_Panel_Ticket_Detalle").dxTabPanel({
            onContentReady: function(){
                self.imageUploadToTicket =  $('#fUploadImageToTicket').dxFileUploader({
                    selectButtonText: 'Seleccione la imagen',
                    multiple: true,
                    ...
                    onValueChanged: function (e) {  
                        ...
                        const files = e.value;
                        let totalSize = 0;
                        const MAX_TOTAL_SIZE = 13 * 1024 * 1024; // 13 MB en bytes

                        // Sumamos el tamaño de todos los archivos seleccionados
                        for (let i = 0; i < files.length; i++) {
                        ...
                        if (totalSize > MAX_TOTAL_SIZE) {
                            DevExpress.ui.notify(
                                "El tamaño total de los archivos no debe exceder los 13 MB.",
                                "error",
                                4000
                            );

                            // // Limpiar los archivos seleccionados
                            // const uploaderInstance = $("#fUploadImageToTicket").dxFileUploader("instance");
                            // uploaderInstance.option("value", []); // Resetea los archivos seleccionados
                        }
                    },  
                }).dxFileUploader("instance");
        ...
        self.uploadImageToTicket = async function(lengthRequired = false){
            ...
            let promisesUploadImages = []; // Inicializamos el arreglo de promesas
            let MSFormData = new FormData();

            let ProvidersUploadFiles = new FormData();
            let dataProvidersUploadsFiles = {};
            const headers = {
                'Authorization': 'Bearer YOUR_ACCESS_TOKEN',
                'Custom-Header': 'YourHeaderValue'
            };
            if (self.Frm_Ticket_Servicio_Instance.getEditor("CAM_CSC_SERVICIO_SOLICITA").option("value") == 5) {
                dataProvidersUploadsFiles = {ClaveEmp: "CREATIF",EmpresaHost: "1",TypeCon: "Pro",ClaveDoc: "TICKET",IdEmpleado: 1,cscEmpleado: 1,NewIdEquipo: self.Frm_Ticket_Servicio_Instance.getEditor("TIC_NEWID").option("value"),OrigenCrea: 1};    
                ProvidersUploadFiles.append('extra', JSON.stringify(dataProvidersUploadsFiles));
                if (files.length > 0) {
                    for(let iP =0; iP<files.length; iP++) {
                        let fileiP = files[iP];
                        ProvidersUploadFiles.append('fileToUpload', fileiP);
                    }    
                }

                promisesUploadImages.push(
                    self.cargaImagenServidores(
                        `https://objecstorage.dnasystem.io/UploadImagenTicketOts`,
                        ProvidersUploadFiles,
                        headers
                    )
                )
            }
            if (self.Frm_Ticket_Servicio_Instance.getEditor("CAM_CSC_SERVICIO_SOLICITA").option("value") == 38) {
                dataProvidersUploadsFiles = {ClaveEmp: "SRMSOTIC",EmpresaHost: "1",TypeCon: "Pro",ClaveDoc: "TICKET",IdEmpleado: 1,cscEmpleado: 1,NewIdEquipo: self.Frm_Ticket_Servicio_Instance.getEditor("TIC_NEWID").option("value"),OrigenCrea: 1};    
                ProvidersUploadFiles.append('extra', JSON.stringify(dataProvidersUploadsFiles));
                if (files.length > 0) {
                    for(let iP =0; iP<files.length; iP++) {
                        let fileiP = files[iP];
            ...
            if (self.Frm_Ticket_Servicio_Instance.getEditor("CAM_CSC_SERVICIO_SOLICITA").option("value") == 8) { //UPLOAD IMAGES TO UNINET
                    if (files.length > 0) {
                        let dataJsonUpload = [];
                        const maxSize = 13 * 1024 * 1024;
                        let totalSize = 0;
                        for(let i =0; i<files.length; i++) {
                            let filetoBaseConvert = files[i];
                            totalSize += filetoBaseConvert.size;
                            // Validamos si el tamaño del archivo excede los 3 MB
                            if (filetoBaseConvert.size > maxSize) {
                                self.notificaPantalla("Alerta", moment().tz(self.TimeZoneEmpleado).format(' DD/MM/YYYY HH:mm'), `El archivo ${filetoBaseConvert.name} excede el límite de tamaño de 13 MB. Por favor, sube archivos más pequeños.`, 400, 130);
                                return; // Detenemos la ejecución si algún archivo es demasiado grande
                            }
                            
                            // Esperamos a que el archivo se convierta a Base64 usando Promesas
                            const imgBase64Data = await self.readFileAsBase64(filetoBaseConvert);

                            const extractedData = self.extractBase64Data(imgBase64Data);

                            // Creamos el objeto para cada archivo
                            const objInsert = {
                                AttachmenType: filetoBaseConvert.type,
                                AttachmenName: filetoBaseConvert.name,
                                AttachmenSize: filetoBaseConvert.size,
                                AttachmenBlob: extractedData,
                            };

                            // Añadimos el objeto al array
                            dataJsonUpload.push(objInsert);
                        }

                        if (totalSize > maxSize) {
                            self.notificaPantalla("Alerta", moment().tz(self.TimeZoneEmpleado).format(' DD/MM/YYYY HH:mm'),
                                `El tamaño total de los archivos excede el límite de 13 MB. Por favor, elimina algunos archivos.`, 400, 130);
                            return;
                        }
                        ...
                        console.log(maxSize);
                        loadPanel.hide();
                        let objUploadToUninet={
                            ...ReturnDefaultData_Init(),
                            TIC_NEWID: self.Frm_Ticket_Servicio_Instance.getEditor("TIC_NEWID").option("value"),
                            TIC_ID_EXTERNO_PROVEEDOR: self.Frm_Ticket_Servicio_Instance.getEditor("TIC_ID_EXTERNO_PROVEEDOR").option("value"),
                            aryImages: dataJsonUpload
                        }

                        __Reques_ajax(getJSON(DeveloperType).ApiTickets_v2.url+'uploadImagesTicketUninetCosci','POST',JSON.stringify(objUploadToUninet),getJSON(DeveloperType).ApiTickets_v2.token).then((resUploadUninet)=>{
                            console.log(resUploadUninet);
                        });
                }
            }

            if (self.Frm_Ticket_Servicio_Instance.getEditor("CAM_CSC_SERVICIO_SOLICITA").option("value") == 11) { //UPLOAD IMAGES TO UNINET
                if (files.length > 0) {
                    let dataJsonUpload = [];
                    const maxSize = 13 * 1024 * 1024; // 13 MB en bytes
                    ...
                    __Reques_ajax(getJSON(DeveloperType).ApiTickets_v2.url+'uploadImagesTicketUninetWlanEndPoint','POST',JSON.stringify(objUploadToUninet),getJSON(DeveloperType).ApiTickets_v2.token).then((resUploadUninet)=>{
                        console.log(resUploadUninet);
                    });
                }    
            }

            if (self.Frm_Ticket_Servicio_Instance.getEditor("CAM_CSC_SERVICIO_SOLICITA").option("value") == 20) { //UPLOAD IMAGES TO UNINET
                if (files.length > 0) {
                    let dataJsonUpload = [];
                    ...
                    for(let i =0; i<files.length; i++) {
                        ...
                        // Validamos si el tamaño del archivo excede los 3 MB
                        if (filetoBaseConvert.size > maxSize) {
                            self.notificaPantalla("Alerta", moment().tz(self.TimeZoneEmpleado).format(' DD/MM/YYYY HH:mm'), `El archivo ${filetoBaseConvert.name} excede el límite de tamaño de 3 MB. Por favor, sube archivos más pequeños.`, 400, 130);
                            return; // Detenemos la ejecución si algún archivo es demasiado grande
                        }
                        ...
                        const extractedData = self.extractBase64Data(imgBase64Data, false);
                    ...
                    __Reques_ajax(getJSON(DeveloperType).ApiTickets_v2.url+'uploadFilesTicketAsNice','POST',JSON.stringify(objUploadToUninet),getJSON(DeveloperType).ApiTickets_v2.token).then((resUploadUninet)=>{
                        console.log(resUploadUninet);
                    });
                }    
            }

            if (self.Frm_Ticket_Servicio_Instance.getEditor("CAM_CSC_SERVICIO_SOLICITA").option("value") == 10) { //UPLOAD IMAGES TO CHERWELL COSIP
                let MSFormDataCOSIP = new FormData();
                if (files.length > 0) {
                    let dataJsonUpload = [];
                    const maxSize = 3 * 1024 * 1024; // 3 MB en bytes
                    ...
                    for(let i =0; i<files.length; i++) {
                        ...
                        const extractedData = self.extractBase64Data(imgBase64Data, true);
                        ...
                        const objInsert = {
                            ...
                            AttachmenName: filetoBaseConvert.name,
                            AttachmenSize: filetoBaseConvert.size,
                            //AttachmenBlob: imgBase64Data,
                        };

                        // Añadimos el objeto al array
                        dataJsonUpload.push(objInsert);

                        MSFormDataCOSIP.append('fileToUpload', filetoBaseConvert);
                    }
                    
                    

                    let objUploadToCosip={
                        ...ReturnDefaultData_Init(),
                        TIC_NEWID: self.Frm_Ticket_Servicio_Instance.getEditor("TIC_NEWID").option("value"),
                        TIC_ID_EXTERNO_PROVEEDOR: self.Frm_Ticket_Servicio_Instance.getEditor("TIC_ID_EXTERNO_PROVEEDOR").option("value"),
                        aryImages: dataJsonUpload
                    ...
                    MSFormDataCOSIP.append('extraData', JSON.stringify(objUploadToCosip));

                    self.cargaImagenServidores(
                        `${getJSON(DeveloperType).ApiTickets_v2.url}uploadImagesToCOSIP`,
                        MSFormDataCOSIP,
                        {
                            'access-token': getJSON(DeveloperType).ApiTickets_v2.token
                        }
                    )
                }    
            }
            ...
            MSFormData.append('extra', JSON.stringify(ExtraVars));
            
            if (files.length > 0) {
                for(let i =0; i<files.length; i++) {
                    let file = files[i];
                    MSFormData.append('fileToUpload', file);
                }    
            }

            promisesUploadImages.push(
                self.cargaImagenServidores(
                    `${getJSON(DeveloperType).Bot_Internal_Storage_Anam.url}uploadImagesToTicket/${self.Frm_Ticket_Servicio_Instance.getEditor("CAM_CSC_SERVICIO_SOLICITA").option("value")}`,
                    MSFormData,
                    headers
                )
            )
            ...
            try {
                let resultsCargaImagenes = await Promise.allSettled(promisesUploadImages);
                // Puedes verificar el estado de cada promesa si es necesario
                resultsCargaImagenes.forEach((result, index) => {
                    if (result.status === 'fulfilled') {
                        console.log(`Promesa ${index + 1} se resolvió correctamente.`);
                        self.imageUploadToTicket.reset();
                        self.Get_Ticket_Foto();
                    } else {
                        console.log(`Promesa ${index + 1} falló.`);
                    }
                });
                ...
                DevExpress.ui.notify({
                message: 'Ocurrió un error en el proceso de carga.',
                minWidth: 150,
                type: 'error',
                displayTime: 5000
        ...
        self.cargaImagenServidores = async function(url, formData, headers = {}) {
            try {
              // Crear la solicitud XMLHttpRequest
              const xhr = new XMLHttpRequest();
              xhr.open('POST', url);

              // Agregar encabezados (si los hay)
              ...
              xhr.upload.addEventListener("progress", function(evt) {
                if (evt.lengthComputable) {
                  ...
                  // Aquí podrías actualizar una barra de progreso en la interfaz de usuario
                }
              }, false);
          
              // Retornar una promesa que se resuelve cuando la carga finaliza
              ...
              console.error(error);
              DevExpress.ui.notify({
                message: 'Error de comunicación con servidor',
                minWidth: 150,
                type: 'error',
                displayTime: 5000
              }, { position: 'bottom right', direction: 'up-push' });
        ...
        self.uploadFileToTicket = async function(lengthRequired = false, idProviderCreate = 0){
            if (self.Frm_Ticket_Servicio_Instance.getEditor("CAM_CSC_SERVICIO_SOLICITA").option("value") == null) {
                self.notificaPantalla("Alerta", moment().tz(self.TimeZoneEmpleado).format(' DD/MM/YYYY HH:mm'), `Selecciona el proveedor en el detalle de solicitud`, 400, 130);
                return
            }
            ...
            if (self.Frm_Ticket_Servicio_Instance.getEditor("CAM_CSC_SERVICIO_SOLICITA").option("value") == 5) {
                ...
                promisesUploadImages.push(
                    self.cargaDocumentosServidores(
                        `https://objecstorage.dnasystem.io/UploadDocumentosTicketOts`,
                        ProvidersUploadFiles,
                        headers
                    )
                )
            ...
            if (self.Frm_Ticket_Servicio_Instance.getEditor("CAM_CSC_SERVICIO_SOLICITA").option("value") == 10) { //UPLOAD FILES TO CHERWELL COSIP
                let MSFormDataCOSIP = new FormData();
                if (files.length > 0) {
                    let dataJsonUpload = [];
                    const maxSize = 3 * 1024 * 1024; // 3 MB en bytes
                    ...
                    for(let i =0; i<files.length; i++) {
                        ...
                        const objInsert = {
                            ...
                            AttachmenName: filetoBaseConvert.name,
                            AttachmenSize: filetoBaseConvert.size,
                            //AttachmenBlob: filetoBaseConvert,
                        };
                    ...
                    if (idProviderCreate == 0) {
                        ...
                        objUploadToCosip={
                            ...ReturnDefaultData_Init(),
                            TIC_NEWID: self.Frm_Ticket_Servicio_Instance.getEditor("TIC_NEWID").option("value"),
                            TIC_ID_EXTERNO_PROVEEDOR: idProviderCreate,
                            aryImages: dataJsonUpload
                        }
                    }
            ...
            promisesUploadImages.push(
                self.cargaDocumentosServidores(
                    `${getJSON(DeveloperType).Bot_Internal_Storage_Anam.url}uploadDocumentToTicket/${self.Frm_Ticket_Servicio_Instance.getEditor("CAM_CSC_SERVICIO_SOLICITA").option("value")}`,
                    MSFormData,
                    headers
                )
            )
        ...
        self.cargaDocumentosServidores = async function(url, formData, headers = {}) {
            try {
              // Crear la solicitud XMLHttpRequest
              const xhr = new XMLHttpRequest();
              xhr.open('POST', url);
                ...
                xhr.onload = () => {
                  if (xhr.status === 200) {
                    ...
                    if (data.success === true) {
                      ...
                      //self.imageUploadToTicket.reset();
                      DevExpress.ui.notify({
                        message: 'Documento(s) cargada(s) correctamente',
                        minWidth: 150,
                        type: 'success',
                        displayTime: 5000
                      }, { position: 'bottom right', direction: 'up-push' });
                      ...
                      reject('Error al subir documento(s)');
                    }
                  } else {
                    reject('Error de comunicación con el servidor');
                  }
        ...
        self.Frm_Ticket_Servicio_Instance = $('#__Frm_Ticket_Servicio').dxForm({
            ...
            /** INICIO: NO VISIBLES */
                {
                    ...
                    items:[
                        {
                            colSpan:6,
                            dataField: "TIC_JSON_EXTRA_PARAMS",
                            label: {
                                text: "JSONPARAMSEX"
                            },
                            editorOptions: {
            ...
            /** FIN: NO VISIBLES */
            {
                    ...
                    editorOptions: {
                        ...
                        onOpened: function(e) {
                            e.component.getDataSource().load().done(function(data) {
                                ...
                                let dataUserService = self._ClienteProyectoCampania_ObjData;
                                console.log(dataUserService);
                                
                                //e.component.option('dataSource', self._ClienteProyectoCampania_ObjData);

                                let __ActiveCat = jslinq(dataUserService._array).where(function(el) {
                                    return el.PM_CSC_PROYECTO != 9 && el.PM_CSC_PROYECTO != 7;
                                }).toList();
                        ...
                        onValueChanged: function (e) {
                            ...
                            if (item == null) {
                                ...
                                let __firstData = jslinq(self._CMB_SAMT_CAM_SERVICIO_OBJDATA._array).where(function(el) {return el.PM_CSC_PROYECTO == newValue;}).toList();
                    ...
                    label: {
                        ...
                        editorOptions: {
                            ...
                            onValueChanged: function (e) {
                                ...
                                if (parseInt(newValue) == 11 || parseInt(newValue) == 8) {
                                ...
                                if (parseInt(newValue) == 7793) {
                                    self.Frm_Ticket_Servicio_Instance.itemOption("TIC_AUXS3", {
                                        validationRules: [
                                            {
                                                type: "required",
                                            ...
                                            },
                                            {
                                                type: "pattern",
                                                pattern: /^\+[0-9]{5}$/,
                                                message: "Debe ser un '+' seguido de 5 dígitos"
                                            },
                                            {
                                                type: "stringLength",
                                                min: 6,
                                                max: 6,
                                                message: "Debe tener exactamente 6 caracteres (incluyendo el '+')"
                                            }
                                        ]
                                    });                                        
                                } else {
                                ...
                                let _ary_RequisProveedor = {Tbl:"SAMT_REQUISICION_PROVEEDORES",WHR:"EMP_CSC_EMPRESA_HOST = " + localStorage.getItem('EMP_CSC_EMPRESA_HOST') +" AND CAM_CSC_SERVICIO = " + newValue };
                                __Get_catalogos(getJSON(DeveloperType).ApiGeneral.url+'Get_Cat_Whr','GET',_ary_RequisProveedor,getJSON(DeveloperType).ApiGeneral.token).then((dataResponse)=>{
                                    if (dataResponse.success === true) {
                                        ...
                                        if (self.inicativasDGMEIA.includes(newValue)) {
                                            let __DGMEIAParents = jslinq(dataResponse.JsonData).where(function(el) {
                                                return el.SAMT_REQUISICION_PROVEEDORES_PARENT == null;
                                            }).toList();
                                            
                                            self.Frm_Ticket_Servicio_Instance.itemOption("INM_CSCINMUEBLE", {
                                                visible:true,
                                                validationRules: [
                                                    {
                                                        type: "required",
                                            ...
                                            self.Frm_Ticket_Servicio_Instance.itemOption("TIC_SEGMENTACION_INM_DES", {
                                                editorOptions: {
                                                    readOnly: true,
                                                }
                                            });

                                            self.Frm_Ticket_Servicio_Instance.getEditor('REQ_CSCREQUISICION').option('dataSource', __DGMEIAParents)
                                        } else {
                                            self.Frm_Ticket_Servicio_Instance.itemOption("INM_CSCINMUEBLE", {
                                                visible:false,
                                                validationRules: []
                        ...
                        editorOptions: {
                            ...
                            onOpened: function(e) {
                                e.component.getDataSource().load().done(function(data) {
                                    ...
                                    let _cmbServicioSelected = self.Frm_Ticket_Servicio_Instance.getEditor('CAM_CSC_SERVICIO_SOLICITA').option('selectedItem');

                                    if (_cmbServicioSelected == null) {
                                    ...
                                    var __ActiveCat = jslinq(data).where(function(el) {
                                        return el.ESTATUS_TICKET_ACTIVO == 1 && el.CAM_CSC_SERVICIO == self.Frm_Ticket_Servicio_Instance.getEditor('CAM_CSC_SERVICIO_SOLICITA').option('value');
                                    }).toList();
                                    e.component.option('dataSource', __ActiveCat);
                                });
                            },
                            ...
                            onValueChanged: function (e) {
                                ...
                                if (item == null) {
                                    ...
                                    //Agregar funcionalidad y tomar 
                                    
                                    if (item.ESTATUS_TICKET_CERRAR == 1 && item.ESTATUS_TICKET_CLAVE == 'CANCELADO') {
                                    ...
                                    if (item.ESTATUS_TICKET_CLAVE == 'RESUELTO' || item.ESTATUS_TICKET_CLAVE == 'CANCELADO') {
...

                {
                    ...
                    editorType: "dxTextBox",
                    label: {
                        text: 'Extensión (Utilizar el simbolo de + y 5 digitos)'
                    },
                    editorOptions: {
                        placeholder: "Ejemplo +12345"  // Placeholder con el formato esperado
                    }
                },                
                 {
                        colSpan: 2,
                        ...
                        editorOptions: {
                            ...
                            onValueChanged: function (e) {     
                                ...
                                if (item == null) {
                                    ...
                                    self.Frm_Ticket_Servicio_Instance.getEditor('TIC_CODIGO_VPN').option('value', item.REQUISICION_PROVEEDORES_CODIGO_VPN)
                                }                        
                            }
                        },
                        validationRules: [{
                        ...
                        editorOptions: {
                            ...
                            onOpened: function (e) {
                                e.component.getDataSource().load().done(function(data) {
                                    ...
                                    var __ActiveCat = null
                                    let _cmbRequisSelected = self.Frm_Ticket_Servicio_Instance.getEditor('REQ_CSCREQUISICION').option('selectedItem');
                                    
                                    if (self.inicativasDGMEIA.includes(_cmbServicioSelected.CAM_CSC_SERVICIO)) {
                                        __ActiveCat = jslinq(data).where(function(el) {
                                            return el.REQUISICION_PROVEEDORES_ACTIVO == 1 && el.CAM_CSC_SERVICIO == self.Frm_Ticket_Servicio_Instance.getEditor('CAM_CSC_SERVICIO_SOLICITA').option('value') && el.SAMT_REQUISICION_PROVEEDORES_PARENT == _cmbRequisSelected.SAMT_REQUISICION_PROVEEDORES_CSC;
                                        }).toList();
                                    } else {
                                        __ActiveCat = jslinq(data).where(function(el) {
                                            return el.REQUISICION_PROVEEDORES_ACTIVO == 1 && el.CAM_CSC_SERVICIO == self.Frm_Ticket_Servicio_Instance.getEditor('CAM_CSC_SERVICIO_SOLICITA').option('value');
                            ...
                            onClosed: function (e) {
                                if (e.component.getDataSource().items() !== self.INM_CSCINMUEBLE) {
                                    e.component.option('dataSource', self.INM_CSCINMUEBLE);
                                }
                            },
                            onValueChanged: function (e) {     
                                var newValue = e.value;
                                ...
                                if (item == null) {
                                    ...
                                    self.Frm_Ticket_Servicio_Instance.getEditor('TIC_SEGMENTACION_INM_DES').option('value', item.REQUISICION_PROVEEDORES_NOMBRE)
                                    self.Frm_Ticket_Servicio_Instance.getEditor('TIC_CODIGO_VPN').option('value', item.REQUISICION_PROVEEDORES_CODIGO_VPN)
                                }                        
                            }
                        }
                ...
                items:[
                    {
                        ...
                        items:[
                                ...
                                editorOptions: {
                                    ...
                                    onOpened: function(e) {
                                        e.component.getDataSource().load().done(function(data) {
                                            ...
                                            let _cmbServicioSelected = self.Frm_Ticket_Servicio_Instance.getEditor('TIPIFICA_CSC_PARENT_PARENT').option('selectedItem');

                                            if (_cmbServicioSelected == null) {
                                                self.notificaPantalla("Información", moment().tz(self.TimeZoneEmpleado).format(' DD/MM/YYYY HH:mm'), `Debes seleccionar la categoria`, 400, 130)
                                                e.component.option('dataSource', []);
                                                return;
                                            }
                                            ...
                                            var __ActiveCat = jslinq(data).where(function(el) {
                                                let __cmbSelectedItem = self.Frm_Ticket_Servicio_Instance.getEditor('CAM_CSC_SERVICIO_SOLICITA').option('selectedItem');
                                                return el.TIPIFCA_ACTIVO == 1 && el.TIPIFICA_PARENT == self.Frm_Ticket_Servicio_Instance.getEditor('TIPIFICA_CSC_PARENT_PARENT').option('value') && el.CAT_TIPO_TIPIFICA_CSC == __cmbSelectedItem.TIPIFICA_CSC;
                                            }).toList();
                                            e.component.option('dataSource', __ActiveCat);
                                        });
                                    },
                                ...
                                editorOptions: {
                                    ...
                                    onOpened: function(e) {
                                        e.component.getDataSource().load().done(function(data) {
                                            ...
                                            let _cmbServicioSelected = self.Frm_Ticket_Servicio_Instance.getEditor('TIPIFICA_CSC_PARENT').option('selectedItem');

                                            if (_cmbServicioSelected == null) {
                                                self.notificaPantalla("Información", moment().tz(self.TimeZoneEmpleado).format(' DD/MM/YYYY HH:mm'), `Debes seleccionar la categoria Nivel 2`, 400, 130)
                                                e.component.option('dataSource', []);
                                                return;
                                            }
                                            ...
                                            var __ActiveCat = jslinq(data).where(function(el) {
                                                let __cmbSelectedItem = self.Frm_Ticket_Servicio_Instance.getEditor('CAM_CSC_SERVICIO_SOLICITA').option('selectedItem');
                                                return el.TIPIFCA_ACTIVO == 1 && el.TIPIFICA_PARENT == self.Frm_Ticket_Servicio_Instance.getEditor('TIPIFICA_CSC_PARENT').option('value') && el.CAT_TIPO_TIPIFICA_CSC == __cmbSelectedItem.TIPIFICA_CSC;
                                            }).toList();
                                            e.component.option('dataSource', __ActiveCat);
                                        });
                                    },
                            ...
                            },
                            {
                                ...
                                label: {
                                    text: 'TAG/COMPONENTE/NO. DE SERIE/HOSTNAME'
                                },
                                editorOptions: {
                                    buttons: [{
                                        name: 'btn_BuscarActivos',
                                        location: 'after',
                                        options: {
                                            stylingMode: 'Contained',
                                            icon: 'search',
                                            ...
                                            onClick(e) {
                                                loadPanel.show()
                                                if (self.Frm_Ticket_Servicio_Instance.getEditor('CAM_CSC_SERVICIO_SOLICITA').option('value') == null || self.Frm_Ticket_Servicio_Instance.getEditor('CAM_CSC_SERVICIO_SOLICITA').option('value') == '') {
                                                    self.notificaPantalla("Información", moment().tz(self.TimeZoneEmpleado).format(' DD/MM/YYYY HH:mm'), `Seleccione el proveedor y el servicio`, 400, 130)
                                                    loadPanel.hide()
                                                } else {
                                                    let categoriaNivel1 = self.Frm_Ticket_Servicio_Instance.getEditor('TIPIFICA_CSC_PARENT_PARENT').option('selectedItem');
                                                    let categoriaNivel2 = self.Frm_Ticket_Servicio_Instance.getEditor('TIPIFICA_CSC_PARENT').option('selectedItem');
                                                    let categoriaNivel3 = self.Frm_Ticket_Servicio_Instance.getEditor('TIPIFICA_CSC').option('selectedItem');
                                                    let inmSelected = self.Frm_Ticket_Servicio_Instance.getEditor('REQ_CSCREQUISICION').option('selectedItem');

                                                    if (self.Frm_Ticket_Servicio_Instance.getEditor('CAM_CSC_SERVICIO_SOLICITA').option('value') == 12) {
                                                        if (categoriaNivel3 == null) {
                                                            self.notificaPantalla("Información", moment().tz(self.TimeZoneEmpleado).format(' DD/MM/YYYY HH:mm'), `Seleccione la categoria de Nivel 3`, 400, 130)
                                                            loadPanel.hide()
                                                            return;
                                                        }
                                                        self.BusquedaActivoFijo();
                                                    } else if (self.Frm_Ticket_Servicio_Instance.getEditor('CAM_CSC_SERVICIO_SOLICITA').option('value') == 25) {
                                                        if (inmSelected == null) {
                                                            self.notificaPantalla("Información", moment().tz(self.TimeZoneEmpleado).format(' DD/MM/YYYY HH:mm'), `Seleccione el Ubicación/Aduana/Almacen`, 400, 130)
                                                            loadPanel.hide()
                                                            return;
                                                        }
                                                        self.BusquedaActivoFijo();
                                                    } else if (self.Frm_Ticket_Servicio_Instance.getEditor('CAM_CSC_SERVICIO_SOLICITA').option('value') == 6) {
                                                        if (inmSelected == null) {
                                                            self.notificaPantalla("Información", moment().tz(self.TimeZoneEmpleado).format(' DD/MM/YYYY HH:mm'), `Seleccione el Ubicación/Aduana/Almacen`, 400, 130)
                                                            loadPanel.hide()
                                                            return;
                                                        ...
                                                        self.BusquedaActivoFijo();
                                                    } else if (self.Frm_Ticket_Servicio_Instance.getEditor('CAM_CSC_SERVICIO_SOLICITA').option('value') == 3) {
                                                        if (inmSelected == null) {
                                                            self.notificaPantalla("Información", moment().tz(self.TimeZoneEmpleado).format(' DD/MM/YYYY HH:mm'), `Seleccione el Ubicación/Aduana/Almacen`, 400, 130)
                                                            loadPanel.hide()
                                                            return;
                                                        ...
                                                        if (categoriaNivel2 == null) {
                                                            self.notificaPantalla("Información", moment().tz(self.TimeZoneEmpleado).format(' DD/MM/YYYY HH:mm'), `Seleccione la categoria de Nivel 2`, 400, 130)
                                                            loadPanel.hide()
                                                            return;
                                                        }
                                                        self.BusquedaActivoFijo();
                                                    } 
                                                    // INICIATIVAS DGMEIA 18,19,20,21,36
                                                    else if (self.Frm_Ticket_Servicio_Instance.getEditor('CAM_CSC_SERVICIO_SOLICITA').option('value') == 18) {
                                                        if (inmSelected == null) {
                                                            self.notificaPantalla("Información", moment().tz(self.TimeZoneEmpleado).format(' DD/MM/YYYY HH:mm'), `Seleccione el Ubicación/Aduana/Almacen`, 400, 130)
                                                            loadPanel.hide()
                                                            return;
                                                        ...
                                                        let DGMEIA_inmSelected = self.Frm_Ticket_Servicio_Instance.getEditor('INM_CSCINMUEBLE').option('selectedItem');
                                                        if (DGMEIA_inmSelected == null) {
                                                            self.notificaPantalla("Información", moment().tz(self.TimeZoneEmpleado).format(' DD/MM/YYYY HH:mm'), `Seleccione el Punto táctico`, 400, 130)
                                                            loadPanel.hide()
                                                            return;
                                                        }
                                                        self.BusquedaActivoFijo();
                                                    }
                                                    else if (self.Frm_Ticket_Servicio_Instance.getEditor('CAM_CSC_SERVICIO_SOLICITA').option('value') == 19) {
                                                        if (inmSelected == null) {
                                                            self.notificaPantalla("Información", moment().tz(self.TimeZoneEmpleado).format(' DD/MM/YYYY HH:mm'), `Seleccione el Ubicación/Aduana/Almacen`, 400, 130)
                                                            loadPanel.hide()
                                                            return;
                                                    ...
                                                    else if (self.Frm_Ticket_Servicio_Instance.getEditor('CAM_CSC_SERVICIO_SOLICITA').option('value') == 20) {
                                                        if (inmSelected == null) {
                                                            self.notificaPantalla("Información", moment().tz(self.TimeZoneEmpleado).format(' DD/MM/YYYY HH:mm'), `Seleccione el Ubicación/Aduana/Almacen`, 400, 130)
                                                            loadPanel.hide()
                                                            return;
                                                    ...
                                                    else if (self.Frm_Ticket_Servicio_Instance.getEditor('CAM_CSC_SERVICIO_SOLICITA').option('value') == 21) {
                                                        if (inmSelected == null) {
                                                            self.notificaPantalla("Información", moment().tz(self.TimeZoneEmpleado).format(' DD/MM/YYYY HH:mm'), `Seleccione el Ubicación/Aduana/Almacen`, 400, 130)
                                                            loadPanel.hide()
                                                            return;
                                                    ...
                                                    else if (self.Frm_Ticket_Servicio_Instance.getEditor('CAM_CSC_SERVICIO_SOLICITA').option('value') == 36) {
                                                        if (inmSelected == null) {
                                                            self.notificaPantalla("Información", moment().tz(self.TimeZoneEmpleado).format(' DD/MM/YYYY HH:mm'), `Seleccione el Ubicación/Aduana/Almacen`, 400, 130)
                                                            loadPanel.hide()
                                                            return;
                                                    ...
                                                    // INICIATIVAS DGMEIA 18,19,20,21,36
                                                    //COVECA 1
                                                    else if (self.Frm_Ticket_Servicio_Instance.getEditor('CAM_CSC_SERVICIO_SOLICITA').option('value') == 24) {
                                                        if (inmSelected == null) {
                                                            self.notificaPantalla("Información", moment().tz(self.TimeZoneEmpleado).format(' DD/MM/YYYY HH:mm'), `Seleccione el Ubicación/Aduana/Almacen`, 400, 130)
                                                            loadPanel.hide()
                                                            return;
                                                    ...
                                                    //COVECA 2
                                                    else if (self.Frm_Ticket_Servicio_Instance.getEditor('CAM_CSC_SERVICIO_SOLICITA').option('value') == 2) {
                                                        if (inmSelected == null) {
                                                            self.notificaPantalla("Información", moment().tz(self.TimeZoneEmpleado).format(' DD/MM/YYYY HH:mm'), `Seleccione el Ubicación/Aduana/Almacen`, 400, 130)
                                                            loadPanel.hide()
                                                            return;
                            ...
                            },
                            {
                                ...
                                buttonOptions: {
                                    type: 'default',
                                    text: "Agregar información complementaría",
                                    onClick: function() {
                                        let campoServicio = self.Frm_Ticket_Servicio_Instance.getEditor('CAM_CSC_SERVICIO_SOLICITA').option('value')
                                        if (campoServicio == 12 || campoServicio == 3) {
                                            let categoriaNivel1 = self.Frm_Ticket_Servicio_Instance.getEditor('TIPIFICA_CSC_PARENT_PARENT').option('selectedItem');

                                            if (categoriaNivel1 == null) {
                                                self.notificaPantalla("Información", moment().tz(self.TimeZoneEmpleado).format(' DD/MM/YYYY HH:mm'), `Seleccione la categoria en la parte superior`, 400, 130)
                                            } else {
                                                self.muestraPopComplementosTicket(categoriaNivel1.TIPIFICA_IDIOMA1);
                                            }    
                                        } else if (campoServicio == 23) {
                                            let categoriaNivel3 = self.Frm_Ticket_Servicio_Instance.getEditor('TIPIFICA_CSC').option('selectedItem');

                                            if (categoriaNivel3 == null) {
                                                self.notificaPantalla("Información", moment().tz(self.TimeZoneEmpleado).format(' DD/MM/YYYY HH:mm'), `Seleccione la categoria nivel 3 en la parte superior`, 400, 130)
                                            } else {
                                                self.popDatosSiadeconSrv(categoriaNivel3.TIPIFICA_IDIOMA1);
                                            }    
                                        } else{
                                            self.notificaPantalla("Información", moment().tz(self.TimeZoneEmpleado).format(' DD/MM/YYYY HH:mm'), `Este servicio no requiere de información complementaria.`, 400, 130)
                                        }
    ...
    function compararObjetos(objetoA, objetoB, _InstanciaFormulario) {
       ...
       // Función que convierte un archivo a Base64 usando Promesas
       self.readFileAsBase64=(file)=>{
            return new Promise((resolve, reject) => {
                const reader = new FileReader();
                reader.onload = function(event) {
                    resolve(event.target.result); // Resolvemos con el Base64
                };
                reader.onerror = function(error) {
                    reject(error); // Rechazamos si ocurre un error
                };
                reader.readAsDataURL(file); // Leemos el archivo como Base64
            });
        }
        // Función para extraer el contenido después de la primera coma
        self.extractBase64Data = (imgBase64Data, returnFull = false) => {
            // Si returnFull es true, devolvemos la cadena completa sin hacer split
            if (returnFull) {
                return imgBase64Data;
            }
        
            // Si returnFull es false, dividimos la cadena en la coma y tomamos la segunda parte
            const base64String = imgBase64Data.split(',')[1];
            return base64String;
        }
      ...
      self.TestBitacoraInsert=(ObjetoCambio)=>{
        ...
        self.InsertaBitacoraManual = function(InfoForm,DescripcionCambio,showLoadPanelBitacora, TipoBitacora, SubTipoBitacora, DataValidacion = null){
            
            if (showLoadPanelBitacora == true) {
                loadPanel.show();      
            }
            ...
            if (DataValidacion != null) {
                let quienReporta = `${obj_DatosEmpleado.EMPLEADO_NOMBREEMPLEADO + ' ' + obj_DatosEmpleado.EMPLEADO_APATERNOEMPLEADO + ' ' + obj_DatosEmpleado.EMPLEADO_AMATERNOEMPLEADO} dice: ${DescripcionCambio}`;
                dataObj.idProveedor = self.Frm_Ticket_Servicio_Instance.getEditor('CAM_CSC_SERVICIO_SOLICITA').option('value');
                dataObj.FolioProveedor = self.Frm_Ticket_Servicio_Instance.getEditor("TIC_ID_EXTERNO_PROVEEDOR").option("value");
                dataObj.DataDescripcion = quienReporta;
                dataObj.TIC_NEWID = self.Frm_Ticket_Servicio_Instance.getEditor('TIC_NEWID').option('value');
            }
    ...
    self.ClickAlta = function(){
        ...
        switch (getUrlParam('TPO_USUARIO')) {
            case 'GENERA':
                ...
                self.Frm_Ticket_Servicio_Instance.getEditor("TIPO_TICKET_CSC").option('readOnly', false);
                self.Frm_Ticket_Servicio_Instance.getEditor("TIPO_PRIORIDAD_CSC").option('readOnly', false);
    ...
    self.Generar_Alta_Ticket=async function(){
        ...
        if (__Frm_Ticket_Servicio_servicio.validate().isValid === true) {
            ...
            if (self.Frm_Ticket_Servicio_Instance.getEditor('CAM_CSC_SERVICIO_SOLICITA').option('value') == 3 ) {
                var __Cmb_RequisSel = self.Frm_Ticket_Servicio_Instance.getEditor('REQ_CSCREQUISICION');
                var __ItemsCmb_RequisSel = __Cmb_RequisSel.option('selectedItem');

                Obj_Data_Insert_Ticket.TIC_TIEMPO_RECEPCION = __ItemsCmb_RequisSel.REQUISICION_PROVEEDORES_SLA;
                Obj_Data_Insert_Ticket.TIC_TIEMPO_EJECUCION = __ItemsCmb_RequisSel.REQUISICION_PROVEEDORES_SLA;
                Obj_Data_Insert_Ticket.TIC_TIEMPO_CONFIRMACION = __ItemsCmb_RequisSel.REQUISICION_PROVEEDORES_SLA;
            } else if (self.Frm_Ticket_Servicio_Instance.getEditor('CAM_CSC_SERVICIO_SOLICITA').option('value') == 25 ) {
                var __Cmb_RequisSel = self.Frm_Ticket_Servicio_Instance.getEditor('REQ_CSCREQUISICION');
                var __ItemsCmb_RequisSel = __Cmb_RequisSel.option('selectedItem');
            ...
            StringsToProvider.TipoIncidenteString = categoriaNivel1.TIPIFICA_IDIOMA1;

            StringsToProvider.tipoTicketProvider = tpoTicketSel.TIPO_TICKET_IDIOMA1;
            StringsToProvider.servicioProvider = categoriaNivel2.TIPIFICA_IDIOMA1;
            StringsToProvider.inmuebleProvider = inmSelected.REQUISICION_PROVEEDORES_NOMBRE;

            if(self.Frm_Ticket_Servicio_Instance.getEditor('CAM_CSC_SERVICIO_SOLICITA').option('value') == 12 ){

                if (categoriaNivel1.TIPIFICA_IDIOMA1 == "ALTA" || categoriaNivel1.TIPIFICA_IDIOMA1 == "BAJA" || categoriaNivel1.TIPIFICA_IDIOMA1 == "CAMBIO") {
                    if (Object.keys(self._DatosComplementariosTicket).length == 0) {
                        self.notificaPantalla("Alerta!", moment().tz(self.TimeZoneEmpleado).format(' DD/MM/YYYY HH:mm'), `La categoria de ticket de tipo ${categoriaNivel1.TIPIFICA_IDIOMA1} requiere información complementaria. por favor agregue los datos.`, 400, 140);
                        loadPanel.hide();
                        return;
                    }
                }
                StringsToProvider.FechaAplicaString = self._DatosComplementariosTicket.FechaAplicaString;
                StringsToProvider.ModeloString = self._DatosComplementariosTicket.ModeloString;
                StringsToProvider.MotivoString = Obj_Data_Insert_Ticket.TIC_DESCRIPCION;
                StringsToProvider.NumeroSerieString = self._DatosComplementariosTicket.NumeroSerieString;
                StringsToProvider.MarcaString = self._DatosComplementariosTicket.MarcaString;
                StringsToProvider.NombreComponente = categoriaNivel2.TIPIFICA_IDIOMA1;
                StringsToProvider.CategoriaAlta = categoriaNivel3.TIPIFICA_IDIOMA1;
                StringsToProvider.TAG_COMPONENTE =  Obj_Data_Insert_Ticket.TAG_COMPONENTE;
                //Obj_Data_Insert_Ticket.TIC_JSON_EXTRA_PARAMS = JSON.stringify(StringsToProvider);
            } else if(self.Frm_Ticket_Servicio_Instance.getEditor('CAM_CSC_SERVICIO_SOLICITA').option('value') == 3 ){ //COSISI
                ...
                if (categoriaNivel1.TIPIFICA_IDIOMA1 == "REQUERIMIENTO DE SERVICIO") {
                    ...
                    if (files.length == 0) {
                        self.notificaPantalla("Alerta!", moment().tz(self.TimeZoneEmpleado).format(' DD/MM/YYYY HH:mm'), `La categoria de ticket de tipo ${categoriaNivel1.TIPIFICA_IDIOMA1} requiere un archivo. Agréguelo en documentos`, 400, 140);
                        loadPanel.hide();
                        return;
                    }
                    ...
                    if (files.length > 0) {
                            let file = files[0];
                            StringsToProvider.AttachmenName = "ArchivoCargado";
                            StringsToProvider.AttachmenSize  = file.size;
                            ...
                            reader.onload = function(event) {
                                ...
                                imgBAse64Data = base64String;
                                var objInsert = {
                                    ...ReturnDefaultData_Init(),
                                    DATA_INSERT: Obj_Data_Insert_Ticket,
                                    DATA_STRINGS_PROVIDERS: StringsToProvider,
                                    DATA_IMAGE_ARCHIVO: imgBAse64Data,
                                };
                                self.InsertTicketProviderTesteo(objInsert);
                            };
                    ...
                    if (files.length == 1) {
                        ...
                        self.notificaPantalla("Alerta!", moment().tz(self.TimeZoneEmpleado).format(' DD/MM/YYYY HH:mm'), `El proveedor solo permite agregar un documento, desvincule los archivos en "Documentos"`, 400, 140);
                        loadPanel.hide();
                        return;
                    } else{
                        StringsToProvider.FechaAplicaString = self._DatosComplementariosTicket.FechaAplicaString;
                ...
                //Obj_Data_Insert_Ticket.TIC_JSON_EXTRA_PARAMS = JSON.stringify(StringsToProvider);
            } else if (self.Frm_Ticket_Servicio_Instance.getEditor('CAM_CSC_SERVICIO_SOLICITA').option('value') == 23){

                if (categoriaNivel3.TIPIFICA_IDIOMA1 == "ALTA DE USUARIO" || categoriaNivel3.TIPIFICA_IDIOMA1 == "BAJA DE USUARIO" || categoriaNivel3.TIPIFICA_IDIOMA1 == "MONITOREO Y SEGUIMIENTO DE VEHÍCULOS"
                    || categoriaNivel3.TIPIFICA_IDIOMA1 == `ACTUALIZACIÓN DE LISTA: "MEDIDA DE CONTROL CPED"`
                ) {
                    if (Object.keys(self._DatosComplementariosTicket).length == 0) {
                        self.notificaPantalla("Alerta!", moment().tz(self.TimeZoneEmpleado).format(' DD/MM/YYYY HH:mm'), `La categoria de ticket de tipo ${categoriaNivel3.TIPIFICA_IDIOMA1} requiere información complementaria. por favor agregue los datos.`, 400, 140);
                        loadPanel.hide();
                        return;
                    }
                }
            } else if (self.Frm_Ticket_Servicio_Instance.getEditor('CAM_CSC_SERVICIO_SOLICITA').option('value') == 36){ //ESPECTROSCOPIA
                StringsToProvider.tipi_1 = categoriaNivel1.TIPIFICA_CLAVE_EXTERNA
                StringsToProvider.tipi_2 = categoriaNivel2.TIPIFICA_CLAVE_EXTERNA
                StringsToProvider.tipi_3 = categoriaNivel3.TIPIFICA_CLAVE_EXTERNA
            } else if (self.Frm_Ticket_Servicio_Instance.getEditor('CAM_CSC_SERVICIO_SOLICITA').option('value') == 19){ //ASTROPHYSICS
                StringsToProvider.tipi_1 = categoriaNivel1.TIPIFICA_CLAVE_EXTERNA
                StringsToProvider.tipi_2 = categoriaNivel2.TIPIFICA_CLAVE_EXTERNA
                StringsToProvider.tipi_3 = categoriaNivel3.TIPIFICA_CLAVE_EXTERNA
                let TipoTiketProvider = 1;
                if (tpoTicketSel.TIPO_TICKET_CSC == 57) {
                    TipoTiketProvider = 2;
                } else if(tpoTicketSel.TIPO_TICKET_CSC == 56){
                    TipoTiketProvider = 1;
                }
                StringsToProvider.tipo_solicitud = TipoTiketProvider
            } else if (self.Frm_Ticket_Servicio_Instance.getEditor('CAM_CSC_SERVICIO_SOLICITA').option('value') == 4){ //SIADECON 1.1
                StringsToProvider.tipi_2 = categoriaNivel2.TIPIFICA_CLAVE_EXTERNA
                StringsToProvider.tipi_3 = categoriaNivel3.TIPIFICA_CLAVE_EXTERNA
            }  else if (self.Frm_Ticket_Servicio_Instance.getEditor('CAM_CSC_SERVICIO_SOLICITA').option('value') == 10){ //COSIP
                StringsToProvider.tipi_1 = categoriaNivel1.TIPIFICA_CLAVE_EXTERNA
                StringsToProvider.tipi_2 = categoriaNivel2.TIPIFICA_CLAVE_EXTERNA
                StringsToProvider.tipi_3 = categoriaNivel3.TIPIFICA_CLAVE_EXTERNA
            } else if (self.Frm_Ticket_Servicio_Instance.getEditor('CAM_CSC_SERVICIO_SOLICITA').option('value') == 20){ //AS&E AMERICAN SINCE
                // 
                let tpoSelPrioridad = self.Frm_Ticket_Servicio_Instance.getEditor('TIPO_PRIORIDAD_CSC').option('selectedItem');
                let tpoSelSeveridad = self.Frm_Ticket_Servicio_Instance.getEditor('TIPO_SEVERIDAD_CSC').option('selectedItem');

                StringsToProvider.tipi_1 = categoriaNivel1.TIPIFICA_CLAVE_EXTERNA
                StringsToProvider.tipi_2 = categoriaNivel2.TIPIFICA_CLAVE_EXTERNA
                StringsToProvider.tipi_3 = categoriaNivel3.TIPIFICA_CLAVE_EXTERNA
                StringsToProvider.idImpacto = tpoSelSeveridad.TIPO_SEVERIDAD_TICKET_IDIOMA2
                StringsToProvider.idUrgencia = 'URG0001'
                StringsToProvider.idPrioridad = tpoSelPrioridad.TIPO_PRIORIDAD_IDIOMA2
                StringsToProvider.tipoOperacion = tpoTicketSel.TIPO_TICKET_IDIOMA2
                StringsToProvider.UBICACION = inmSelected.REQUISICION_PROVEEDORES_NOMBRE
                StringsToProvider.RFCCLIENTE = obj_DatosEmpleado.EMPLEADO_RFC
            }

            else if (self.Frm_Ticket_Servicio_Instance.getEditor('CAM_CSC_SERVICIO_SOLICITA').option('value') == 25){ //COVELI
                StringsToProvider.tipi_1 = categoriaNivel1.TIPIFICA_IDIOMA1;
                StringsToProvider.tipi_2 = categoriaNivel2.TIPIFICA_IDIOMA1;
                StringsToProvider.tipi_3 = categoriaNivel3.TIPIFICA_IDIOMA1;
                StringsToProvider.identificador_componente = Obj_Data_Insert_Ticket.TAG_COMPONENTE;
                StringsToProvider.inmuebleProviderConcat = `VPN ${inmSelected.REQUISICION_PROVEEDORES_CODIGO_VPN} ${inmSelected.REQUISICION_PROVEEDORES_NOMBRE}`;
            }
            
            else if (self.Frm_Ticket_Servicio_Instance.getEditor('CAM_CSC_SERVICIO_SOLICITA').option('value') == 6){ //COVIVI
                StringsToProvider.tipi_1 = categoriaNivel1.TIPIFICA_CLAVE_EXTERNA
                StringsToProvider.tipi_2 = categoriaNivel2.TIPIFICA_CLAVE_EXTERNA
                StringsToProvider.tipi_3 = categoriaNivel3.TIPIFICA_CLAVE_EXTERNA
                StringsToProvider.inmuebleProviderConcat = `${inmSelected.REQUISICION_PROVEEDORES_NOMBRE}`;
                StringsToProvider.identificador_componente = Obj_Data_Insert_Ticket.TAG_COMPONENTE;
            } 
            else if (self.Frm_Ticket_Servicio_Instance.getEditor('CAM_CSC_SERVICIO_SOLICITA').option('value') == 8){ //COCSI
                let tpoSelPrioridad = self.Frm_Ticket_Servicio_Instance.getEditor('TIPO_PRIORIDAD_CSC').option('selectedItem');
                let tpoSelSeveridad = self.Frm_Ticket_Servicio_Instance.getEditor('TIPO_SEVERIDAD_CSC').option('selectedItem');
                let files = self.imageUploadToTicket.option("value");
                let fileWrappers = self.imageUploadToTicket._files;
                if (files.length == 1) {
                        ...
                        StringsToProvider.tipi_3 = categoriaNivel3.TIPIFICA_CLAVE_EXTERNA
                        StringsToProvider.inmuebleProviderConcat = `${inmSelected.REQUISICION_PROVEEDORES_NOMBRE}`;
                        StringsToProvider.urgency = tpoSelPrioridad.TIPO_PRIORIDAD_IDIOMA1;
                        StringsToProvider.impact = tpoSelSeveridad.TIPO_SEVERIDAD_TICKET_IDIOMA1;
                        StringsToProvider.identificador_componente = Obj_Data_Insert_Ticket.TAG_COMPONENTE;
                        StringsToProvider.AttachmenName = file.name;
                        StringsToProvider.AttachmenSize  = file.size;
                        StringsToProvider.AttachmenType  = file.type;
                    ...
                    self.notificaPantalla("Alerta!", moment().tz(self.TimeZoneEmpleado).format(' DD/MM/YYYY HH:mm'), `El proveedor solo permite agregar un imagen, desvincule los archivos en "Imagenes"`, 400, 140);
                    loadPanel.hide();
                    return;
                } else{
                    StringsToProvider.tipi_1 = categoriaNivel1.TIPIFICA_CLAVE_EXTERNA
            ...
            else if (self.Frm_Ticket_Servicio_Instance.getEditor('CAM_CSC_SERVICIO_SOLICITA').option('value') == 11){ //LAN Y WLAN
                let tpoSelPrioridad = self.Frm_Ticket_Servicio_Instance.getEditor('TIPO_PRIORIDAD_CSC').option('selectedItem');
                let tpoSelSeveridad = self.Frm_Ticket_Servicio_Instance.getEditor('TIPO_SEVERIDAD_CSC').option('selectedItem');
                let files = self.imageUploadToTicket.option("value");
                let fileWrappers = self.imageUploadToTicket._files;
                ...
                if (files.length > 0) {
                        let dataJsonUpload = [];
                        const maxSize = 13 * 1024 * 1024; // 3 MB en bytes
            ...
            Obj_Data_Insert_Ticket.TIC_DESCRIPCION += ` \n\n Categoría nivel 1: ${categoriaNivel1.TIPIFICA_IDIOMA1} \n Categoría nivel 2: ${categoriaNivel2.TIPIFICA_IDIOMA1} \n Categoría nivel 3: ${categoriaNivel3.TIPIFICA_IDIOMA1}`
            ...
            __Reques_ajax(getJSON(DeveloperType).ApiTickets_v2.url+'Insert_Ticket_Servicio','POST',JSON.stringify(objInsert),getJSON(DeveloperType).ApiTickets_v2.token).then((in_emp)=>{
                if (in_emp.success == true) {
                    ...
                    if (ResProvider != null) {
                        if (ResProvider.isSuccessProvider == false) {
                            self.notificaPantalla("Alerta!", moment().tz(self.TimeZoneEmpleado).format(' DD/MM/YYYY HH:mm'), `El ticket no fue insertado en la mesa del proveedor, verificar información en bitacora para mas detalle`, 400, 140)
                            self.InsertaBitacoraManual(obj_BitacoraSend,JSON.stringify(ResProvider.errorDetail), true, 2,1);
                        } else {
                            self.InsertaBitacoraManual(obj_BitacoraSend,JSON.stringify(ResProvider.Detail), true, 1,2);
                        }    
                    }
                    ...
                    let valueCscServicioSolicitaUpl = self.Frm_Ticket_Servicio_Instance.getEditor('CAM_CSC_SERVICIO_SOLICITA').option('value');

                    if(valueCscServicioSolicitaUpl == 10){ //Alta Cosip
                        self.uploadImageToTicket(false,`${ResProvider.Detail.busObPublicId}|${ResProvider.Detail.busObRecId}`);
                        self.uploadFileToTicket(false,`${ResProvider.Detail.busObPublicId}|${ResProvider.Detail.busObRecId}`);
                    } else{
                        self.uploadImageToTicket(false,0);
                        self.uploadFileToTicket(false,0);
                    }
                    ...
                    let valueCscServicioSolicita = self.Frm_Ticket_Servicio_Instance.getEditor('CAM_CSC_SERVICIO_SOLICITA').option('value');
                    let mensajeError = "";
                    if (valueCscServicioSolicita == 12 || valueCscServicioSolicita == 3) {
                        mensajeError = `${JSON.stringify(in_emp.ResProvider.errorDetail.message.message)}`
                    } 
                    //COVECA 1
                    else if(valueCscServicioSolicita == 24){
                        mensajeError = `${JSON.stringify(in_emp.ResProvider.errorDetail.message)}`
                    }
                    //COVECA 2
                    else if(valueCscServicioSolicita == 2){
                        mensajeError = `${JSON.stringify(in_emp.ResProvider.errorDetail.message)}`
                    }
                    else if(valueCscServicioSolicita == 25){
                        mensajeError = `${JSON.stringify(in_emp.ResProvider.errorDetail.message.message)}`
                    }
                    else if(valueCscServicioSolicita == 11){
                        mensajeError = `Comunicación con proveedor ${JSON.stringify(in_emp.ResProvider.providerName)} no exitosa ${JSON.stringify(in_emp.ResProvider.Detail)}`
                    }
                    else if(valueCscServicioSolicita == 8){
                        mensajeError = `Comunicación con proveedor ${JSON.stringify(in_emp.ResProvider.providerName)} no exitosa ${JSON.stringify(in_emp.ResProvider.Detail)}`
                    }
                    else{
                        mensajeError = in_emp.message;
                    }
                    self.notificaPantalla("Error de comunicación!", moment().tz(self.TimeZoneEmpleado).format(' DD/MM/YYYY HH:mm'), `${mensajeError}`, 400, 140);
                    loadPanel.hide();
                }
                return in_emp;
            }).catch(function(e){
    ...
    self.InsertTicketProviderTesteo=function(objInsert){
        var __Frm_Ticket_Servicio_servicio = self.Frm_Ticket_Servicio_Instance;
        var Form_Data_Ticket_servicio = self.Frm_Ticket_Servicio_Instance.option('formData');
        __Reques_ajax(getJSON(DeveloperType).ApiTickets_v2.url+'Insert_Ticket_Servicio','POST',JSON.stringify(objInsert),getJSON(DeveloperType).ApiTickets_v2.token).then((in_emp)=>{
            if (in_emp.success == true) {
                ...
                loadPanel.show();
                self.InsertaBitacoraManual(obj_BitacoraSend,Globalize.formatMessage("txtBitaInfoAltaProceso")+": "+ __ValidaEnvio.ESTATUS_TICKET_IDIOMA1, true, 1,2);
    ...
    self.convertFileToBase64=function(file) {
        return new Promise((resolve, reject) => {
            const reader = new FileReader();
            reader.onload = () => {
    ...
    self.Get_Tickets=function(__AryDatos,PopAlert,DgRefresh){
        loadPanel.show();
        __Reques_ajax(getJSON(DeveloperType).ApiTickets_v2.url+'Get_Ticket_Servicio','GET',__AryDatos,getJSON(DeveloperType).ApiTickets_v2.token).then(async (in_emp)=>{
            if (in_emp.success == true) {
                loadPanel.hide();
                ...
                if (CargaFrm.TIC_JSON_EXTRA_PARAMS != null) {
                    CargaFrm.TIC_JSON_EXTRA_PARAMS = JSON.stringify(CargaFrm.TIC_JSON_EXTRA_PARAMS)
                }
                        ...
                        if (CargaFrm.EMPLEADO_CSC_ATIENDE == null) {
                            ...
                            if (getUrlParam('TPO_USUARIO') == 'GENERA') {
                                ...
                                var __Obj_Update = {
                                    ...
                                    "TIC_TIPO_CATEGORIA": tpoTicketSel.TIPO_TICKET_IDIOMA2,
                                    DATA_WHERE:{
                                        "CAM_CSC_SERVICIO_SOLICITA": CargaFrm.CAM_CSC_SERVICIO_SOLICITA,
                                ...
                                self.InsertaBitacoraManual(DetalleTicket,'Ticket asignado a: ' + empleadoAsignado, true, 1,2);
                ...
                if (PopAlert == true) {
                    ...
                    <br><br> Cordial saludo, queremos informarte que su ticket fue generado con éxito, a partir de este momento empezamos el estudio correspondiente para darte una respuesta con la mayor oportunidad posible.`;
    ...
    //! Componente para busqueda de empleados
    self.BusquedaActivoFijo = function (CamposLlena,selMode) {
        const  popupContentTemplate = function () {
            return $('<div>').append(
                $("<div class='popup-property-details'>").append(
                    $('<div class="Nice-Shadow-1" style="padding: 9px;">Buscar activo fijo</div>'),
                    $("<div style='margin: 9px;'/>").attr("id", "DataGridActivosFijosBusqueda").dxDataGrid({
                        headerFilter: { visible: false },
                        keyExpr: "SAMT_CSCEQUIPAMIENTO",
                        dataSource: self._Obj_Activos_Grid_Busqueda,
                        selection: {
                            mode: 'single'
                        },
                        height: 300,
                        ...
                        columns: [
                            {
                                caption: "TAG/HOSTNAME",
                                dataField: "EQUIPAMIENTO_HOSTNAME",
                                width: 110,
                            },
                            {
                                caption: "Alias/Nombre",
                                dataField: "EQUIIPAMIENTO_ALIAS",
                                width: 250,
                            },
                            {
                                caption: "Tipo de bien",
                                dataField: "EQUIPAMIENTO_AUX1S",
                                width: 120,
                            },{
                                caption: "Modelo",
                            ...
                            },
                            {
                                ...
                                buttons: [{
                                    ...
                                    onClick(e) {
                                        ...
                                        let _DatosRespuestaAlta = {};
                                        
                                        _DatosRespuestaAlta.EMP_CSC_EMPRESA_HOST = localStorage.getItem('EMP_CSC_EMPRESA_HOST');
                                        _DatosRespuestaAlta.TIC_NEWID = self.Frm_Ticket_Servicio_Instance.getEditor("TIC_NEWID").option("value");
                                        _DatosRespuestaAlta.EQUIPAMIENTO_NEWID = e.row.data.EQUIPAMIENTO_NEWID;
                                        _DatosRespuestaAlta.SAMT_CSCEQUIPAMIENTO  = e.row.data.SAMT_CSCEQUIPAMIENTO;
                                        _DatosRespuestaAlta.TICKET_EQUIPOS_ACTIVO = 1;
                                        _DatosRespuestaAlta.AUDITORIA_FEC_ALTA = FechaActualSistema;
                                        _DatosRespuestaAlta.AUDITORIA_FEC_ULT_MOD = FechaActualSistema;
                                        _DatosRespuestaAlta.AUDITORIA_USU_ALTA = obj_DatosEmpleado.EMPLEADO_CSC_EMPLEADO;
                                        _DatosRespuestaAlta.AUDITORIA_USU_ULT_MOD = obj_DatosEmpleado.EMPLEADO_CSC_EMPLEADO;

                                        if (e.row.data.EQUIPAMIENTO_HOSTNAME == null) {
                                            self.Frm_Ticket_Servicio_Instance.getEditor('TAG_COMPONENTE').option('value', e.row.data.EQUIPAMIENTO_NO_SERIE)
                                        } else{
                                            self.Frm_Ticket_Servicio_Instance.getEditor('TAG_COMPONENTE').option('value', e.row.data.EQUIPAMIENTO_HOSTNAME)
                                        }
                                        //COVECA 1
                                        if (self.Frm_Ticket_Servicio_Instance.getEditor("CAM_CSC_SERVICIO_SOLICITA").option("value") == 24) {
                                            self.Frm_Ticket_Servicio_Instance.getEditor('TIC_JSON_EXTRA_PARAMS').option('value', e.row.data.EQUIPAMIENTO_NO_INVENTARIO)
                                        }
                                        //COVECA 2
                                        if (self.Frm_Ticket_Servicio_Instance.getEditor("CAM_CSC_SERVICIO_SOLICITA").option("value") == 2) {
                                            self.Frm_Ticket_Servicio_Instance.getEditor('TIC_JSON_EXTRA_PARAMS').option('value', e.row.data.EQUIPAMIENTO_NO_INVENTARIO)
                                        }

                                        if (self.inicativasDGMEIA.includes(self.Frm_Ticket_Servicio_Instance.getEditor("CAM_CSC_SERVICIO_SOLICITA").option("value"))) {
                                            let objJsonTpoBien = {
                                                tpoBien: e.row.data.EQUIPAMIENTO_AUX1S
                                            }
                                            self.Frm_Ticket_Servicio_Instance.getEditor('TIC_JSON_EXTRA_PARAMS').option('value', JSON.stringify(objJsonTpoBien))
                                        }
                                        ...
                                        __Reques_ajax(getJSON(DeveloperType).ApiTickets_v2.url+'Insert_Equipo_Ticket','POST',JSON.stringify(objInsert),getJSON(DeveloperType).ApiTickets_v2.token).then((in_emp)=>{
                                            if (in_emp.success == true) {
                                                DevExpress.ui.notify({message: `Activo agregado correctamente`,minWidth: 150,type: 'success',displayTime: 5000},{position: "bottom right",direction: "up-push"});
                                                loadPanel.hide();
                                                $('#Pop_Notificacion_Success').dxPopup("hide");
                                                //self.Get_Activos_TicketSg()
                                            }
                                            else {
                                                loadPanel.hide();
                                            }
        ...
        $("#Pop_Notificacion_Success").dxPopup("instance").option("height",'450');
        $("#Pop_Notificacion_Success").dxPopup("instance").option("width",'800');
        $("#Pop_Notificacion_Success").dxPopup('instance').option('contentTemplate', popupContentTemplate);
        $('#Pop_Notificacion_Success').dxPopup("show");
        loadPanel.show();
        self._Obj_Activos_Grid_Busqueda.clear()

        if (self.Frm_Ticket_Servicio_Instance.getEditor("CAM_CSC_SERVICIO_SOLICITA").option("value") == 12) {
            let categoriaNivel3 = self.Frm_Ticket_Servicio_Instance.getEditor('TIPIFICA_CSC').option('selectedItem');
            _BusquedaActivos = {
                ...ReturnDefaultData_Init(),
                CAM_CSC_SERVICIO: self.Frm_Ticket_Servicio_Instance.getEditor('CAM_CSC_SERVICIO_SOLICITA').option('value'),
                EQUIPAMIENTO_AUX1S: categoriaNivel3.TIPIFICA_IDIOMA1.trim()
            };    
        } else if (self.Frm_Ticket_Servicio_Instance.getEditor("CAM_CSC_SERVICIO_SOLICITA").option("value") == 3) { //COSISI
            let inmSelected = self.Frm_Ticket_Servicio_Instance.getEditor('REQ_CSCREQUISICION').option('selectedItem');
            let categoriaNivel2 = self.Frm_Ticket_Servicio_Instance.getEditor('TIPIFICA_CSC_PARENT').option('selectedItem');
            _BusquedaActivos = {
                ...ReturnDefaultData_Init(),
                CAM_CSC_SERVICIO: self.Frm_Ticket_Servicio_Instance.getEditor('CAM_CSC_SERVICIO_SOLICITA').option('value'),
                EQUIPAMIENTO_AUX1S: categoriaNivel2.TIPIFICA_IDIOMA1.trim(),
                EQUIPAMIENTO_CODIGO_VPN: inmSelected.REQUISICION_PROVEEDORES_CODIGO_VPN.trim()
            };    
        } else if (self.Frm_Ticket_Servicio_Instance.getEditor("CAM_CSC_SERVICIO_SOLICITA").option("value") == 25) {
            let inmSelected = self.Frm_Ticket_Servicio_Instance.getEditor('REQ_CSCREQUISICION').option('selectedItem');
            _BusquedaActivos = {
                ...ReturnDefaultData_Init(),
                CAM_CSC_SERVICIO: self.Frm_Ticket_Servicio_Instance.getEditor('CAM_CSC_SERVICIO_SOLICITA').option('value'),
                EQUIPAMIENTO_HOSTNAME: inmSelected.REQUISICION_PROVEEDORES_CODIGO_VPN.trim()
            };    
        } else if (self.Frm_Ticket_Servicio_Instance.getEditor("CAM_CSC_SERVICIO_SOLICITA").option("value") == 6) {
            let inmSelected = self.Frm_Ticket_Servicio_Instance.getEditor('REQ_CSCREQUISICION').option('selectedItem');
            _BusquedaActivos = {
        ...
        // INICIATIVAS DGMEIA 18,19,20,21,36
            ...
            _BusquedaActivos = {
                ...ReturnDefaultData_Init(),
                CAM_CSC_SERVICIO: self.Frm_Ticket_Servicio_Instance.getEditor('CAM_CSC_SERVICIO_SOLICITA').option('value'),
                INM_CSCINMUEBLE: DGMEIA_inmSelected.SAMT_REQUISICION_PROVEEDORES_CSC
            };    
        }
        else if (self.Frm_Ticket_Servicio_Instance.getEditor("CAM_CSC_SERVICIO_SOLICITA").option("value") == 19) {
            let inmSelected = self.Frm_Ticket_Servicio_Instance.getEditor('REQ_CSCREQUISICION').option('selectedItem');
            ...
            _BusquedaActivos = {
                ...ReturnDefaultData_Init(),
                CAM_CSC_SERVICIO: self.Frm_Ticket_Servicio_Instance.getEditor('CAM_CSC_SERVICIO_SOLICITA').option('value'),
                EQUIPAMIENTO_CODIGO_VPN: DGMEIA_inmSelected.SAMT_REQUISICION_PROVEEDORES_CSC
            };    
        } 
        else if (self.Frm_Ticket_Servicio_Instance.getEditor("CAM_CSC_SERVICIO_SOLICITA").option("value") == 21) {
            let inmSelected = self.Frm_Ticket_Servicio_Instance.getEditor('REQ_CSCREQUISICION').option('selectedItem');
        ...
        _UrlApi = 'ApiEquipamiento';
        _FnName = 'Get_Equipo';
    
        self.CargarActiosFijos(_BusquedaActivos,_UrlApi,_FnName);    
    }

    self.CargarActiosFijos=(_Parametros,apiData,fnname)=>{
        loadPanel.hide();
        __Reques_ajax(getJSON(DeveloperType)[apiData].url+fnname,'GET',_Parametros,getJSON(DeveloperType)[apiData].token).then((in_emp)=>{
            if (in_emp.success == true) {      
                var selectedRowsData = in_emp.JsonData;
                selectedRowsData.forEach(function(item) {
                    self._Obj_Activos_Grid_Busqueda.insert(item);
                });
                $("#DataGridActivosFijosBusqueda").dxDataGrid("instance").refresh();
                loadPanel.hide();
                ...
                if (self.Frm_Ticket_Servicio_Instance.getEditor("CAM_CSC_SERVICIO_SOLICITA").option("value") == 3) {
                    let categoriaNivel2 = self.Frm_Ticket_Servicio_Instance.getEditor('TIPIFICA_CSC_PARENT').option('selectedItem');
                    self.notificaPantalla("Información", moment().tz(self.TimeZoneEmpleado).format(' DD/MM/YYYY HH:mm'), `No se localizan activos asignados al inmueble del tipo ${categoriaNivel2.TIPIFICA_IDIOMA1.trim()}`, 400, 130)    
                } else{
                    self.notificaPantalla("Información", moment().tz(self.TimeZoneEmpleado).format(' DD/MM/YYYY HH:mm'), `No se localizan activos/inventario`, 400, 130)    
                }
