                                ...
                                if (__ValidaCambiosTicket == true) {
                                    ...
                                    if(self.pauseTicket == true){
                                        if (Form_Data_Ticket_servicio.TIC_ESTATUS_SLA_ENUM == 'open' || Form_Data_Ticket_servicio.TIC_ESTATUS_SLA_ENUM == '') {
                                            ...
                                            let tokenMesaProveedor = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJwcm92aWRlcl9kYXRhIjp7InByb3ZpZGVyX2lkIjo5LCJwcm92aWRlcl9uYW1lIjoiTUVTQSBERSBBWVVEQSBTSUlJREYiLCJwcm92aWRlcl9pZF9lbXAiOjIzOCwicHJvdmlkZXJfZW1waG9zdCI6MSwicHJvdmlkZXJfc2VydmljaW8iOjksImNvbnRleHQiOnsiY2xpZW50VHlwZSI6ImFwaSJ9fSwiaWF0IjoxNzIzNTg5NDMyfQ.-KmZlFVrr4F0EccVLrrLHJajj6zLKICeSfgPzTQJAKo';
                                            __Reques_ajax('https://apimc.anam.gob.mx:3007/pauseTicket/9','POST',JSON.stringify({
                                        ...
                                        if (Form_Data_Ticket_servicio.TIC_ESTATUS_SLA_ENUM == 'pause') {
                                            //Obj_Data_Update_Ticket.TIC_ESTATUS_SLA_ENUM = 'pause';
                                            let tokenMesaProveedor = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJwcm92aWRlcl9kYXRhIjp7InByb3ZpZGVyX2lkIjo5LCJwcm92aWRlcl9uYW1lIjoiTUVTQSBERSBBWVVEQSBTSUlJREYiLCJwcm92aWRlcl9pZF9lbXAiOjIzOCwicHJvdmlkZXJfZW1waG9zdCI6MSwicHJvdmlkZXJfc2VydmljaW8iOjksImNvbnRleHQiOnsiY2xpZW50VHlwZSI6ImFwaSJ9fSwiaWF0IjoxNzIzNTg5NDMyfQ.-KmZlFVrr4F0EccVLrrLHJajj6zLKICeSfgPzTQJAKo';
                                            __Reques_ajax('https://apimc.anam.gob.mx:3007/resumeTicket/9','POST',JSON.stringify({
                                                "newIdTicket":self.DataTicketOpen.TIC_NEWID,
                                                "idEmpresa": 1,
                                                "idEmpleadoProvider": 254
                                            }),tokenMesaProveedor).then((in_emp)=>{
                    ...
                    editorOptions: {
                        ...
                        onOpened: function(e) {
                            e.component.getDataSource().load().done(function(data) {
                                ...
                                let __ActiveCat = {};
                                if (self.Frm_Ticket_Servicio_Instance.getEditor('CAM_MESA_CSC').option('value') == 2) {
                                    __ActiveCat = jslinq(data).where(function(el) {
                                        return el.TIPO_ESTATUS_PROYECTO_CSC == 1 && el.PM_CSC_PROYECTO == 9;
                                    }).toList();
                                } else{
                                    __ActiveCat = jslinq(data).where(function(el) {
