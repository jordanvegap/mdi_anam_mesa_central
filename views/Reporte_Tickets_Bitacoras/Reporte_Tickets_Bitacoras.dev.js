SalesDashboard.dashboardModel = function() {
    ...
    */
    ...
    self.init = function() {
        ...
        $("#treeTicketRepBitacoras").dxTreeView({
            dataSource: [],
            height: '100%',
        ...
        self.DataGridTicketsAdmin = $("#Data_Grid_Ticket_RepBitacoras").dxDataGrid({
            ...
            export: {
                ...
                DevExpress.excelExporter.exportDataGrid({ 
                    ...
                    workbook.xlsx.writeBuffer().then(function(buffer) { 
                        saveAs(new Blob([buffer], { type: 'application/octet-stream' }), 'ReporteBitcoras_'+moment().tz(self.TimeZoneServidor).format('YYYY-MM-DD HH:mm:ss')+'.xlsx'); 
                    }); 
                }); 
                e.cancel = true; 
            },
            columns: [
                ...
                },
                {
                    ...
                    dataField: "FOLIO_TICKET_PROVEEDOR",
                    alignment: "center",
                    width: 160,
                },
                {
                ...
                },
                {
                    ...
                    dataField: "CATEGORIA_NIVEL_2",
                    alignment: "left",
                    width: 180
                },{
                    caption: "CATEGORIA NIVEL 3",
                    dataField: "CATEGORIA_NIVEL_3",
                    alignment: "left",
                    width: 180
                },
                {
                ...
                {
                    caption: "EQUIPO REFERENCIA",
                    dataField: "EQUIPAMIENTO_REFERENCIA",
                    alignment: "left",
                    width: 180
                },
                {
            ...
            onRowDblClick: function (e) {
                //setTimeout(() => {
                    ...
                    //AbrirPopMesaAyuda('SHOWTICKET',e.data.CAM_MESA_CSC,e.data.TIC_NEWID) 
                //}, 1000);
            }
                            ...
                            if (all_data.success == true){
                                ...
                                __Get_catalogos(getJSON(DeveloperType).ApiGeneral.url+'Get_Cat_Whr','GET',_ary_Prioridad,getJSON(DeveloperType).ApiGeneral.token).then((all_data)=>{
                                    if (all_data.success == true){
                                        ...
                                        $("#treeTicketRepBitacoras").dxTreeView("instance").option("dataSource", ArbolPrincipal);
