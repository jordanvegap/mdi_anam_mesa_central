          ...
          onValueChanged: function (e) {
            ...
            array_MesasPreasigna.forEach(function(item) {
              ...
              if (ObjetoNuevo == undefined) {
                ...
                __Reques_ajax(getJSON(DeveloperType).ApiRecursosHumanos.url+'Insert_Mesa_Empleado_Genera','POST',JSON.stringify(_Objeto_Inserta_Api),getJSON(DeveloperType).ApiRecursosHumanos.token).then((in_emp)=>{
                  loadPanel.show();
              ...
              },
              {
                  ...
                  buttons: [{
                    ...
                    onClick(e) {
                      ...
                      __Reques_ajax(getJSON(DeveloperType).ApiRecursosHumanos.url+'Del_Mesa_Empleado_Genera','POST',JSON.stringify(jsonDatDel),getJSON(DeveloperType).ApiRecursosHumanos.token).then((in_emp)=>{
                        loadPanel.show();
                          if (in_emp.success == true) {
                            var jsonServEmpl = {
                              EMP_CLV_EMPRESA:localStorage.getItem('EMP_CLV_EMPRESA'),
